package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_977:Number = 0.71;
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_1229,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_21);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_1229,error);
            Core.dispose();
         }
      }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_977 + this.var_23.getNumberOfFilesLoaded() / _loc11_ * const_977;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
