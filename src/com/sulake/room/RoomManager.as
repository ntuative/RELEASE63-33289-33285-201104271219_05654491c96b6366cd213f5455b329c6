package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_592 = [];
         this.var_591 = [];
         events.addEventListener(RoomContentLoadedEvent.const_433,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_479,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_735,this.onContentLoaded);
      }
      ...
      {
         var _loc1_:* = null;
         if(this.var_590 == null || this.var_489 == null)
         {
            return;
         }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_899.indexOf(_loc2_) < 0)
         {
            this.var_899.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         {
            _loc2_ = this.var_899[0];
            this.var_899.splice(0,1);
                     ...
                     if(_loc15_ != null)
                     {
                        ...
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_590.createRoomObjectLogic(_loc6_);
