package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1268:Number = 32;
      ...
      private var var_2056:Number = 1.0;
      
      private var var_2057:Number = 1.0;
      
      private var var_2055:Number = 1.0;
      
      private var var_95:Vector3d;
      
      private var var_455:Vector3d;
      
      private var var_2957:Number = -500.0;
      
      private var var_2958:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1294 = new Vector3d();
         this.var_2056 = 1;
         this.var_2057 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_2055 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_454.assign(this.var_95);
      ...
      {
         if(this.var_453 != param1 * this.var_2056)
         {
            this.var_453 = param1 * this.var_2056;
            ++this.var_173;
         }
      }
      ...
      {
         if(this.var_456 != param1 * this.var_2057)
         {
            this.var_456 = param1 * this.var_2057;
            ++this.var_173;
         }
      }
      ...
      {
         if(this.var_457 != param1 * this.var_2055)
         {
            this.var_457 = param1 * this.var_2055;
            ++this.var_173;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_95.x /= this.var_453;
         this.var_95.y /= this.var_456;
         this.var_95.z /= this.var_457;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1295.assign(this.var_160);
         }
         else
         {
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1294.assign(_loc22_);
         }
         else
         {
            this.var_1294.assign(_loc17_);
         }
         ++this.var_173;
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc2_:Number = Vector3d.method_1(param1,this._x);
         var _loc3_:Number = Vector3d.method_1(param1,this.var_161);
         var _loc4_:Number = Vector3d.method_1(param1,this.var_160);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.method_1(_loc2_,this.var_1294);
         if(_loc3_ < this.var_2957 || _loc3_ > this.var_2958)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.method_1(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.method_1(_loc2_,this.var_161);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_456;
            _loc2_.z *= this.var_457;
            _loc3_ = Vector3d.method_1(_loc2_,this.var_1294);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_161,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_95.x * this.var_453,this.var_95.y * this.var_456,this.var_95.z * this.var_457);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_160;
         ...
         {
            _loc14_.sub(_loc10_);
            _loc15_ = Vector3d.method_1(_loc14_,param3) / _loc11_.length * param3.length;
            _loc16_ = Vector3d.method_1(_loc14_,param4) / _loc12_.length * param4.length;
