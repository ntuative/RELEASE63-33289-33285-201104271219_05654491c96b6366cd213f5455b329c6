package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_387:IRoomObjectController;
      ...
      public function set object(param1:IRoomObjectController) : void
      {
         ...
         {
            this.var_387.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_387 = param1;
            this.var_387.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_387 != null)
            {
               this.var_387.setLocation(param1.loc);
               this.var_387.setDirection(param1.dir);
            }
         }
      }
   }
