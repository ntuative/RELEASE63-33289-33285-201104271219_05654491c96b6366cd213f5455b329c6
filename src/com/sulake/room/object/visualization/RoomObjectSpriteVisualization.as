package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_387:IRoomObject;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_210 != null)
         {
            ...
            {
               _loc1_ = this.var_210[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(this.var_210.length > param1)
         {
            _loc2_ = this.var_210[this.var_210.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
