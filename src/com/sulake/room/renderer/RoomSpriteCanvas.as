package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_364:int = 50;
      
      private static const const_1422:int = 50;
      
      private static const const_1031:Number = 60;
      
      private static const const_1423:Number = 50;
      ...
      private var var_1471:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2573:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_259.addChild(this.var_100);
      ...
      {
         this.var_523.x -= param1 - this.var_632;
         this.var_632 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_523.y -= param1 - this.var_635;
         this.var_635 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1056 = true;
            if(this.var_134 != null && !this.var_259.contains(this.var_134))
            {
               this.var_259.addChild(this.var_134);
               this.var_100.mask = this.var_134;
            }
         }
         else if(!param1 && this.var_1056)
         {
            this.var_1056 = false;
            if(this.var_134 != null && this.var_259.contains(this.var_134))
            {
               this.var_259.removeChild(this.var_134);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_634 != null)
         {
            ...
            {
               this.cleanSprite(this.var_634[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_634 = [];
         }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_525 != this.var_2569 || this.var_524 != this.var_2572)
         {
            _loc8_ = true;
         }
         if(this.var_100.x != this.var_632 || this.var_100.y != this.var_635)
         {
            this.var_100.x = this.var_632;
            this.var_100.y = this.var_635;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2569 = this.var_525;
         this.var_2572 = this.var_524;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1470 > 0)
         {
            ...
            {
               ++this.var_802;
               if(this.var_802 == const_364 + 1)
               {
                  this.var_501 = _loc2_;
                  this.var_1841 = this.var_2571;
               }
               else if(this.var_802 > const_364 + 1)
               {
                  _loc3_ = Number(this.var_802 - const_364);
                  this.var_501 = this.var_501 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1841 = this.var_1841 * (_loc3_ - 1) / _loc3_ + Number(this.var_2571) / _loc3_;
                  if(this.var_802 > const_364 + const_1422)
                  {
                     this.var_802 = const_364;
                     if(!this.var_1195 && this.var_501 > const_1031)
                     {
                        this.var_1195 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1195 && this.var_501 < const_1423)
                     {
                        this.var_1195 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1844 && this.var_1195);
      ...
      {
         if(param1 < this.var_525 && param1 + param3 >= 0 && (param2 < this.var_524 && param2 + param4 >= 0))
         {
            if(!this.var_2948)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param2 + param4 >= this.var_524)
         {
            param4 -= this.var_524 + 1 - (param2 + param4);
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_634.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_801 || this.var_801 == 0)
         {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_788.redMultiplier = tR;
            this.var_788.greenMultiplier = tG;
            this.var_788.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_788);
            if(name.length > 0)
            {
               this.var_260.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_632;
         param2 -= this.var_635;
         this.var_523.x = param1;
         this.var_523.y = param2;
         if(this.var_1194 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1843;
         }
         this.var_1843 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1194;
         return this.var_1843;
      }
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc12_:Number = param2 - this.var_524 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1842,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_631.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_631.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2568 || param2 != this.var_2573)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_631.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_631.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         while(_loc1_ < this.var_361.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1471.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1194 == 0)
         {
            this.checkMouseHits(this.var_523.x,this.var_523.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1194 = 0;
         ++this.var_1842;
      }
