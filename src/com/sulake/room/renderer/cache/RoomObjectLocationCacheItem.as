package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1680 || param1.getUpdateID() != this.var_2580)
         {
            this.var_2580 = param1.getUpdateID();
            if(param2.updateId != this.var_1680 || _loc4_.x != this.var_1198.x || _loc4_.y != this.var_1198.y || _loc4_.z != this.var_1198.z)
            {
