package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1719 || param2 != this.var_1720)
         {
      ...
      {
         if(this.var_1397 > 255 || bitmapData == null)
         {
            return false;
         }
