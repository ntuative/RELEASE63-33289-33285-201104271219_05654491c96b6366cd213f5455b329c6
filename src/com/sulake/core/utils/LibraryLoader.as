package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1824:uint = 1;
      
      protected static const const_1827:uint = 2;
      
      protected static const const_1825:uint = 4;
      
      protected static const const_1826:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1642:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1303:Boolean = false;
      
      public static const const_1757:int = 2;
      
      private static var var_920:Array = new Array();
      
      private static var var_750:Array = new Array();
      ...
      protected var var_2990:uint = 0;
      
      protected var var_2906:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1303)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_750[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_750.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_750.length < const_1757 && false)
            {
               _loc1_ = var_920.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1070 ? uint(this.var_1326 - this.var_2119) : uint(getTimer() - this.var_2119);
      }
      ...
      {
         if(this.var_1071 && !_disposed)
         {
            this.var_1071 = false;
            if(!this.var_1070 && this.var_240)
            {
               this.var_1326 = -1;
               this.var_2119 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1070 && !_disposed && this.var_1327 > 0)
         {
            try
            {
               this.var_43.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_240,const_1642 - this.var_1327);
            if(this.var_2906)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_470 == LibraryLoader.const_1826)
         {
