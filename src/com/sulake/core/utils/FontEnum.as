package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_679:Map = new Map();
      
      private static const const_368:Map = new Map();
      
      private static var var_1305:Boolean = false;
      ...
      {
         return const_679.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1305)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_679.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1305 = true;
         }
