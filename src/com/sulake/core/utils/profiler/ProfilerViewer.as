package com.sulake.core.utils.profiler
{
   ...
   public class ProfilerViewer extends TextField implements IDisposable
   {
      ...
      public function ProfilerViewer(param1:IProfiler)
      {
         ...
         {
            this.var_208 = param1;
            this.var_208.addStopEventListener(this.refresh);
         }
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_208)
            {
               this.var_208.removeStopEventListener(this.refresh);
               this.var_208 = null;
            }
            this._disposed = true;
         }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:Array = this.var_208.getProfilerAgentsInArray();
