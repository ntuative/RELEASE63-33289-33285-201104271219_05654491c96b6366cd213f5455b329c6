package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1773:String = "float";
      ...
      public static const const_237:String = "Point";
      
      public static const const_284:String = "Rectangle";
      
      public static const const_137:String = "Array";
      
      public static const const_267:String = "Map";
      
      private static const const_644:String = "key";
      
      private static const TYPE:String = "type";
      
      private static const const_645:String = "value";
      
      private static const const_671:String = "IHabboSoundManager";
      
      private static const const_1835:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         if(_loc7_.length() > 0)
         {
            _loc4_ = String(param1.attribute(const_644));
         }
         else
         {
            _loc4_ = param1.child(const_644)[0];
         }
         ...
         _loc7_ = param1.attribute(const_645);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_645));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_645)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_267 || _loc5_ == const_137)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_143:
               return uint(param1);
            case const_137:
               return param1.split(const_1319);
            default:
