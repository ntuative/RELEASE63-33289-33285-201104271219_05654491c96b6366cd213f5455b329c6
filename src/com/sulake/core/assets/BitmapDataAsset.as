package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      private var var_1668:AssetTypeDeclaration;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_499 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_108 is BitmapDataAsset)
         {
            ...
            this.var_1484 = BitmapDataAsset(this.var_108).var_1484;
            this.var_1483 = BitmapDataAsset(this.var_108).var_1483;
            if(this._bitmap != null)
            {
               this.var_108 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1484 = _loc4_ == "1" || _loc4_ == "IHabboSoundManager";
                  break;
               case "flipV":
                  this.var_1483 = _loc4_ == "1" || _loc4_ == "IHabboSoundManager";
                  break;
            }
            _loc2_++;
         }
