package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1073 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_43 = new Loader();
         this.var_1079 = new LoaderContext();
         this.var_1079.checkPolicyFile = true;
         ...
         {
            this.var_43.load(param2,this.var_1079);
         }
      }
      ...
      {
         this.var_1073 = param1.url;
         var_328 = 0;
         this.var_43.load(param1,this.var_1079);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_328 < var_2900)
            {
               ...
               this.var_43.load(new URLRequest(this.var_1073 + (this.var_1073.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_328),this.var_1079);
               return true;
            }
         }
         return false;
