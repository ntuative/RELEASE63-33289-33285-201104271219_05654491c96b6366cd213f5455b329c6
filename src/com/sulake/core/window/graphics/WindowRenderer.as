package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1480:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_1858 = new Point();
         this.var_1480 = new Rectangle();
         this.var_311 = new Rectangle();
         this.var_365 = new Dictionary(true);
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_311.x = param2.x - param1.x;
            this.var_311.y = param2.y - param1.y;
            this.var_311.width = param2.width;
            this.var_311.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_33))
            {
               while(param1.testParamFlag(WindowParam.const_33))
               {
                  ...
                  this.var_311.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_311,WindowRedrawFlag.const_1124);
            if(this.var_804.indexOf(param1) == -1)
            {
      ...
      {
         var _loc2_:WindowRendererItem = this.var_365[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_365[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            this.var_365[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_854,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_854,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_365[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_365[param1];
         }
      }
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_804.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_804.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_311.x = _loc3_.dirty.x;
               this.var_311.y = _loc3_.dirty.y;
               this.var_311.width = _loc3_.dirty.width;
               this.var_311.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_311,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1858,this.var_1480))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1858,this.var_1480))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_33))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1480);
