package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1797:uint = 0;
      
      public static const const_925:uint = 1;
      
      public static const const_1213:uint = 2;
      
      public static const const_877:uint = 4;
      
      public static const const_1762:uint = 8;
      
      public static const const_1538:uint = 16;
      
      public static const const_1972:uint = 64;
      
      public static const const_1967:uint = 128;
      
      public static const const_1093:uint = 256;
         ...
         if(this.var_869)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2120,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2120,16777215);
                  }
                  var_331 += bitmap.width * bitmap.height * 4;
               }
