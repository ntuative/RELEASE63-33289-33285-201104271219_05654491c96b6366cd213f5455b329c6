package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_475[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_788.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_788.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_788.blueMultiplier = (param1.color & 255) / 255;
            ...
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_788);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_396 == SkinLayoutEntity.const_322)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_396 == SkinLayoutEntity.const_492)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_396 == SkinLayoutEntity.const_316)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.var_397 == SkinLayoutEntity.const_322)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_397 == SkinLayoutEntity.const_492)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_397 == SkinLayoutEntity.const_316)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_397 == SkinLayoutEntity.const_316 || _loc10_.var_396 == SkinLayoutEntity.const_316)
                  {
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_396 == SkinLayoutEntity.const_322)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_397 == SkinLayoutEntity.const_322)
               {
