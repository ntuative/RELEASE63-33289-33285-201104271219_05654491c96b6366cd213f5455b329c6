package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_114:String = "active";
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         var _loc6_:* = param2.attribute("transparent") == "IHabboSoundManager";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         _loc5_.colorize = _loc6_ == "" ? true : _loc6_ == "IHabboSoundManager";
         _loc6_ = null;
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_396 = SkinLayoutEntity.const_477;
                  break;
               case "move":
                  _loc5_.var_396 = SkinLayoutEntity.const_322;
                  break;
               case "strech":
                  _loc5_.var_396 = SkinLayoutEntity.const_492;
                  break;
               case "tiled":
                  _loc5_.var_396 = SkinLayoutEntity.const_316;
                  break;
               case "center":
                  _loc5_.var_396 = SkinLayoutEntity.const_1103;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_397 = SkinLayoutEntity.const_477;
                  break;
               case "move":
                  _loc5_.var_397 = SkinLayoutEntity.const_322;
                  break;
               case "strech":
                  _loc5_.var_397 = SkinLayoutEntity.const_492;
                  break;
               case "tiled":
                  _loc5_.var_397 = SkinLayoutEntity.const_316;
                  break;
               case "center":
                  _loc5_.var_397 = SkinLayoutEntity.const_1103;
            }
         }
      ...
      protected static function parseState(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         switch(_loc5_)
         {
            case BitmapSkinParser.const_114:
               _loc10_ = 0;
               break;
