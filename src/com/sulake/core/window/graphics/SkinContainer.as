package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1455:String = "skin";
      
      private static const const_1451:String = "bitmap";
      
      private static const const_1452:String = "fill";
      
      private static const const_1456:String = "text";
      
      private static const const_1454:String = "label";
      
      private static const const_1453:String = "shape";
      ...
      private var var_2714:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(this.var_1955,this.var_2712);
         this.var_2713 = new Dictionary();
         this.var_2714 = new Dictionary();
         StateCodeTable.fillTables(this.var_2713,this.var_2714);
         this.var_439 = new Dictionary();
         this.var_439[const_1455] = BitmapSkinRenderer;
         this.var_439[const_1451] = BitmapDataRenderer;
         this.var_439[const_1452] = FillSkinRenderer;
         this.var_439[const_1456] = TextSkinRenderer;
         this.var_439[const_1454] = LabelRenderer;
         this.var_439[const_1453] = ShapeSkinRenderer;
         this.var_439[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_439[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_333 == null)
         {
            var_333 = new Array();
            var_333.push(WindowState.const_70);
            var_333.push(WindowState.const_86);
            var_333.push(WindowState.const_100);
            var_333.push(WindowState.const_55);
            var_333.push(WindowState.const_91);
            var_333.push(WindowState.const_90);
            var_333.push(WindowState.const_114);
            var_333.push(WindowState.const_103);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2897 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "IHabboSoundManager" : false;
                  ...
                  this.addSkinRenderer(this.var_1955[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1014[param1] = new Array(const_1052);
         }
         this.var_1014[param1][param2] = param3;
         if(this.var_1015[param1] == null)
         {
            this.var_1015[param1] = new Array(const_1052);
         }
         this.var_1015[param1][param2] = param4;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1015[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_171)
