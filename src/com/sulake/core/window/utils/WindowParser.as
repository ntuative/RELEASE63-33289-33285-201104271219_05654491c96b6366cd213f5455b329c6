package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1200:String = "_EXCLUDE";
      
      public static const const_2000:String = "_INCLUDE";
      
      public static const const_1908:String = "_TEMP";
      
      private static const const_1481:String = "layout";
      
      private static const const_1056:String = "window";
      
      private static const const_1057:String = "variables";
      
      private static const const_1058:String = "filters";
      
      private static const const_455:String = "name";
      
      private static const const_1486:String = "style";
      
      private static const const_672:String = "params";
      
      private static const const_1480:String = "tags";
      ...
      private static const const_1482:String = "caption";
      ...
      private static const const_1484:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1485:String = "treshold";
      
      private static const const_1488:String = "children";
      
      private static const const_1483:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1490:String = "height_min";
      
      private static const const_1477:String = "height_max";
      
      private static const const_671:String = "IHabboSoundManager";
      
      private static const const_169:String = "0";
      
      private static const const_1478:String = "$";
      
      private static const const_1319:String = ",";
      
      private static const const_49:String = "";
      
      private static const const_1489:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1479:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1343:Dictionary;
      
      protected var var_1342:Dictionary;
      
      protected var var_1080:Dictionary;
      
      protected var var_1615:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1343,this.var_1342);
         this.var_1080 = new Dictionary();
         this.var_1615 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1080,this.var_1615);
         this.var_2141 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1479,const_49);
         return param1.replace(const_1489,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1343)
            {
               delete this.var_1343[_loc1_];
            }
            for(_loc1_ in this.var_1342)
            {
               delete this.var_1342[_loc1_];
            }
            for(_loc1_ in this.var_1080)
            {
               delete this.var_1080[_loc1_];
            }
            for(_loc1_ in this.var_1615)
            {
               delete this.var_1615[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1481)
         {
            _loc8_ = param1.child(const_1057);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc4_ = param1.child(const_1056);
         ...
         if(param1.localName() == const_1056)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1343[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_455,variables,"")));
         style = uint(this.parseAttribute(xml,const_1486,variables,style));
         params = uint(this.parseAttribute(xml,const_672,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1480,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_169));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_169));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_169));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_169));
         visible = this.parseAttribute(xml,const_1487,variables,visible.toString()) == const_671;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_672).length() > 0)
         {
            list = xml.child(const_672).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               ...
               if(this.var_1080[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_455)) + "\"!");
               }
               params |= this.var_1080[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_49) : const_49;
         caption = unescape(String(this.parseAttribute(xml,const_1482,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1319);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1057)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1483,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1490,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1477,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_671;
         blend = Number(this.parseAttribute(xml,const_1308,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1484,variables,window.clipping.toString()) == const_671;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1485,variables,window.mouseThreshold.toString()));
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1342[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1200) == -1)
                  {
