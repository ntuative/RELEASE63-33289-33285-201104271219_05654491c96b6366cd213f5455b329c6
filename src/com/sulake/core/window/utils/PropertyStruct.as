package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_2923 = param3 == const_267 || param3 == const_137 || param3 == const_237 || param3 == const_284;
      ...
      public function toString() : String
      {
         switch(this._type)
         {
            ...
            case const_40:
               return Boolean(this.var_177) == true ? "IHabboSoundManager" : "false";
            case const_237:
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            ...
            case const_284:
               ...
               break;
            case const_143:
               _loc1_ = "<var key=\"" + this.var_583 + "\" value=\"" + "0x" + uint(this.var_177).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_583 + "\" value=\"" + this.var_177 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
