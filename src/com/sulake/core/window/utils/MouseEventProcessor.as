package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_332 = new Array();
            var_332[0] = MouseCursorType.const_345;
            var_332[1] = MouseCursorType.const_30;
            var_332[2] = MouseCursorType.const_345;
            var_332[3] = MouseCursorType.const_345;
            var_332[4] = MouseCursorType.const_345;
            var_332[5] = MouseCursorType.const_30;
            var_332[6] = MouseCursorType.const_345;
         }
         if(var_288 == null)
         {
            var_288 = new Array();
            var_288[0] = WindowState.const_114;
            var_288[1] = WindowState.const_90;
            var_288[2] = WindowState.const_91;
            var_288[3] = WindowState.const_70;
            var_288[4] = WindowState.const_55;
            var_288[5] = WindowState.const_100;
            var_288[6] = WindowState.const_86;
         }
      }
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_210;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_174 = state.var_1320 as WindowController;
         this.var_165 = state.renderer;
         this.var_872 = state.var_1321;
         eventQueue.begin();
         this.var_700.x = -1;
         this.var_700.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_700.x || event.stageY != this.var_700.y)
            {
               ...
               array = new Array();
               this.var_82.groupParameterFilteredChildrenUnderPoint(this.var_700,array,WindowParam.const_31);
            }
            ...
            if(index == 0)
            {
               ...
               {
                  if(this.var_62 != this.var_82 && !this.var_62.disposed)
                  {
                     ...
                     this.var_62 = WindowController(this.var_82);
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_62 && !this.var_62.disposed)
                     {
                        ...
                        {
                           this.var_872.mouseEventReceived(event.type,this.var_62);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1320 = this.var_174;
         state.renderer = this.var_165;
         state.var_1321 = this.var_872;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_610))
         {
