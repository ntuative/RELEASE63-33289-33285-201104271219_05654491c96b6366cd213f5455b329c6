package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_496:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_648:String = "{";
      
      private static const const_647:String = "}";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_496.indexOf(_loc4_.name) == -1)
            {
               var_496.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "IHabboSoundManager" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_647);
         if(countSubStrings(param1,const_648) != countSubStrings(param1,const_647))
         {
            throw new Error("Mismatching amount of \"" + const_648 + "\" versus \"" + const_647 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1338) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1337) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_648)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
