package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_318:int = 2.147483647E9;
      
      private var var_319:int = -2.147483648E9;
      ...
      {
         this.var_318 = param1;
         if(this.var_318 < int.MAX_VALUE && !this._target.disposed && this._target.width > this.var_318)
         {
            this._target.width = this.var_318;
         }
      }
      ...
      {
         this.var_319 = param1;
         if(this.var_319 > int.MIN_VALUE && !this._target.disposed && this._target.height < this.var_319)
         {
      ...
      {
         return this.var_321 == int.MIN_VALUE && this.var_318 == int.MAX_VALUE && this.var_319 == int.MIN_VALUE && this.var_320 == int.MAX_VALUE;
      }
      
      public function setEmpty() : void
      {
         this.var_321 = int.MIN_VALUE;
         this.var_318 = int.MAX_VALUE;
         this.var_319 = int.MIN_VALUE;
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            else if(this._target.width > this.var_318)
            {
               this._target.width = this.var_318;
            }
            if(this._target.height < this.var_319)
            {
               this._target.height = this.var_319;
            }
