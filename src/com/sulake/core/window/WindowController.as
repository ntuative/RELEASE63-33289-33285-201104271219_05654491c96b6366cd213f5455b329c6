package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1314:String = "_COLORIZE";
      
      protected static const const_1313:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_1070:Point = new Point();
      ...
      protected var var_708:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_718 = _loc13_.blend;
            var_477 = _loc13_.var_2897;
      ...
      public static function resizeToAccommodateChildren(param1:WindowController, param2:Boolean = true) : void
      {
         ...
         if(_loc9_)
         {
            ...
            if(param2)
            {
               ...
               while(_loc3_ < _loc10_)
               {
                  _loc12_ = param1.testParamFlag(WindowParam.const_106);
                  if(_loc12_)
                  {
                     param1.setParamFlag(WindowParam.const_106,false);
                  }
                  param1.offset(-_loc4_,-_loc5_);
                  if(_loc12_)
                  {
                     param1.setParamFlag(WindowParam.const_106,true);
                  }
                  _loc3_++;
               }
            }
      ...
      {
         return this.var_708 != null ? this.var_708 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_476 = param1;
         var_241 = !!var_476 ? uint(var_241 | var_577) : uint(var_241 & 16777215);
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_241 = !!var_476 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      ...
      {
         var_577 = param1 << 24;
         var_241 = !!var_476 ? uint(var_577 | var_241) : uint(16777215 & var_241);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      
      public function set blend(param1:Number) : void
      {
         var_718 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_846);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_78)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1313) == -1)
               {
                  _loc4_.style = var_78;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_390 = this._parent.rectangle.clone();
               var_61.x = var_11.x;
               var_61.y = var_11.y;
               var_61.width = var_11.width;
               var_61.height = var_11.height;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_548,this,this._parent);
            ...
            else
            {
               this.var_390.x = 0;
               this.var_390.y = 0;
               this.var_390.width = 0;
               this.var_390.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1665,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_925,var_11);
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_78,var_20,_context,var_11,null,this.var_708,this.properties,var_878.concat(),_id) as WindowController;
         _loc2_.var_477 = var_477;
         _loc2_.var_176 = this.var_176;
         _loc2_._debug = this._debug;
         _loc2_.var_390 = this.var_390.clone();
      ...
      override public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            if(true)
            {
               ...
               {
                  if(this.getStateFlag(WindowState.const_114))
                  {
                     this.deactivate();
                  }
               }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2870 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_499)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_559)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_580)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1075,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_241,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
            ...
            switch(param2.type)
            {
               case WindowMouseEvent.const_42:
                  ...
                  if(testParamFlag(WindowParam.const_422))
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_263))
                        {
                  ...
                  if((var_20 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_331))
                        {
               ...
               case WindowMouseEvent.const_52:
                  ...
                  if(testParamFlag(WindowParam.const_331))
                  {
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_41:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_944,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_220,WindowParam.const_170))
                     {
                     ...
                     if(this._parent != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_552))
                        {
               ...
               case WindowEvent.const_241:
                  _context.invalidate(this,var_11.union(var_61),WindowRedrawFlag.const_1129);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1636,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_201,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_482:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1074,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_297,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_548:
                  ...
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
                  break;
               case WindowEvent.const_944:
                  this._parent.getRegionProperties(null,this.var_390);
                  this.updateScaleRelativeToParent();
                  break;
         ...
         if(this.var_176 && var_477 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_1070,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_1070,param3,param1)) : false;
            }
         }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_78 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1313) == -1)
               {
                  _loc6_.style = var_78;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_135,WindowParam.const_170);
         var _loc2_:* = !testParamFlag(WindowParam.const_138,WindowParam.const_183);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_390.width;
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_395)
               {
                  _loc3_.width += _loc4_;
               }
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_390.height;
               _loc5_ = uint(var_20 & 0);
      ...
      {
         if(_state == WindowState.const_638)
         {
            return true;
         }
         _state = WindowState.const_638;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1795,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1769,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1776,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1555,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_114,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_482,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_114,false);
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1592,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_70,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1698,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_949,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_872,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_190,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1674,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_475,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_475,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
