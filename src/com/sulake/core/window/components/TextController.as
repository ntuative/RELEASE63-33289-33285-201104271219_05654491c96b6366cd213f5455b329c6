package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      private var var_424:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_424,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_424 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_424,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_843 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_424);
      }
      ...
      {
         this.var_870 = param1;
         this._field.scrollH = this.var_870 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_870 * this.maxScrollH,this.var_570 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_424);
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_844,this._field.antiAliasType,PropertyStruct.const_56,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1211));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1172 ? new PropertyStruct(PropertyDefaults.const_822,this._autoSize,PropertyStruct.const_56,true,PropertyDefaults.const_1287) : PropertyDefaults.const_1661);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_40,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_143,this._field.borderColor != 0));
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1267 ? new PropertyStruct(PropertyDefaults.const_1258,this._field.gridFitType,PropertyStruct.const_56,true,PropertyDefaults.const_1109) : PropertyDefaults.const_1584);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_898) ? new PropertyStruct(PropertyDefaults.const_399,this._field.textColor,PropertyStruct.const_143,true) : PropertyDefaults.const_1242);
         _loc1_.push(this.var_424 != TextStyleManager.const_197 ? new PropertyStruct(PropertyDefaults.const_423,this.var_424,PropertyStruct.const_56,true,PropertyDefaults.const_702) : PropertyDefaults.const_1208);
         _loc1_.push(this.var_41.left != PropertyDefaults.const_903 ? new PropertyStruct(PropertyDefaults.const_257,this.var_41.left,PropertyStruct.const_43,true) : PropertyDefaults.const_628);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_798 ? new PropertyStruct(PropertyDefaults.const_253,this.var_41.top,PropertyStruct.const_43,true) : PropertyDefaults.const_523);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_743 ? new PropertyStruct(PropertyDefaults.const_251,this.var_41.right,PropertyStruct.const_43,true) : PropertyDefaults.const_464);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_916 ? new PropertyStruct(PropertyDefaults.const_235,this.var_41.bottom,PropertyStruct.const_43,true) : PropertyDefaults.const_514);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1291 ? new PropertyStruct(PropertyDefaults.const_914,this._field.mouseWheelEnabled,PropertyStruct.const_40,true) : PropertyDefaults.const_1632);
