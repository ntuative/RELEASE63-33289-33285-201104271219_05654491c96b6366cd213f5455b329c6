package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_593)
         {
            if(param2.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
            {
               param1.context.getWindowServices().getToolTipAgentService().begin(param1);
            }
            else if(param2.type != WindowMouseEvent.const_221)
            {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_593)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_889,param1.toolTipCaption,PropertyStruct.const_56,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1692);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1282)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_897,param1.toolTipDelay,PropertyStruct.const_276,true));
         }
         else
         {
