package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1345:String = "_TITLE";
      
      private static const const_1342:String = "_HEADER";
      
      private static const const_1344:String = "_CONTENT";
      
      private static const const_1343:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1383:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1345) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1383 = findChildByTag(const_1342) as IHeaderWindow;
            if(!this.var_1383)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_180 = findChildByTag(const_1344) as IWindowContainer;
            if(!this.var_180)
            {
      ...
      {
         return findChildByTag(const_1343) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1314,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1070 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_331);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_289);
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_257,_loc3_.left,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_253,_loc3_.top,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_251,0 - _loc3_.right,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_235,0 - _loc3_.bottom,PropertyStruct.const_43,_loc2_));
         }
         else
         {
