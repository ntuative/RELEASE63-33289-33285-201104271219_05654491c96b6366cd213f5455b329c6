package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2132:Boolean = false;
      ...
      protected var var_1077:Boolean = true;
      
      protected var var_474:Boolean = false;
      
      protected var var_1340:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_176 = var_476 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_427,WindowStyle.const_171,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_201,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1340;
      }
      ...
      {
         return new Rectangle(this.var_703 * this.maxScrollH,this.var_701 * this.maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_201,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_221:
               if(this.var_1338)
               {
                  this.var_1339 = this.var_2130 - _loc3_;
                  this.var_1341 = this.var_2131 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1339 != 0 && this.var_109 != 0)
                     {
                        this.scrollH += this.var_1339 / this.var_109;
                     }
                  }
                  else if(this.var_1341 != 0 && this.var_96 != 0)
                  {
                     this.scrollV += this.var_1341 / this.var_96;
                  }
                  this.var_2130 = _loc3_;
                  this.var_2131 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_210:
               if(this.var_1338)
               {
                  ...
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1341);
                  }
                  this.var_1338 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1077 && !this.var_574 && this._container)
         {
            this.var_574 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_932)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_441,this._spacing,PropertyStruct.const_43,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1080);
         }
         if(this.var_1077 != PropertyDefaults.const_1156)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_789,this.var_1077,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1799);
         }
         if(this.var_474 != PropertyDefaults.const_1192)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_876,this.var_474,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1761);
         }
         if(this.var_1340 != PropertyDefaults.const_1087)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_727,this.var_1340,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1749);
         }
         if(this.var_702 != PropertyDefaults.const_1205)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_936,this.var_702,PropertyStruct.const_126,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1564);
         }
         if(this.var_704 != PropertyDefaults.const_1228)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_749,this.var_704,PropertyStruct.const_126,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_789:
                  this.var_1077 = _loc2_.value as Boolean;
                  break;
