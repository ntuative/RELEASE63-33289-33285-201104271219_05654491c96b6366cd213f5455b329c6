package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1335:String = "increment";
      
      private static const const_1336:String = "decrement";
      
      private static const const_986:String = "slider_track";
      
      private static const const_646:String = "slider_bar";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_176 = false;
         this.var_17 = param12;
         this._horizontal = param2 == WindowType.const_529;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_17 != null && !this.var_17.disposed)
         {
            ...
            this.var_17.removeEventListener(WindowEvent.const_595,this.onScrollableScrolled);
         }
         this.var_17 = param1;
         if(this.var_17 != null && !this.var_17.disposed)
         {
            this.var_17.addEventListener(WindowEvent.const_41,this.onScrollableResized);
            this.var_17.addEventListener(WindowEvent.const_595,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_906 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_986) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_646) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_646:
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_42 || param1.type == WindowTouchEvent.const_808)
         {
            if(param2.name == const_1335)
            {
               if(this.var_17)
               {
                  this.var_1107 = true;
            ...
            else if(param2.name == const_1336)
            {
               if(this.var_17)
               {
                  this.var_1107 = true;
            ...
            else if(param2.name == const_986)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_646).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_906) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_906) as IScrollableWindow;
               if(_loc1_)
               {
