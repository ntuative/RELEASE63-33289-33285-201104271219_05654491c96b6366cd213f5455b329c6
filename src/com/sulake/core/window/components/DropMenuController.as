package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_188 == null || this.var_188.disposed)
         {
            this.var_188 = context.create(name + "::submenu","",WindowType.const_472,var_78,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_974 = false;
            this.getTitleLabel().text = this.var_630 < this.var_258.length && this.var_630 > -1 ? this.var_258[this.var_630] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_545,var_78,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_427,var_78,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_630 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_630).setStateFlag(WindowState.const_55,true);
         }
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_52:
               ...
               break;
            case WindowTouchEvent.const_861:
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_258.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_708,this.var_258,PropertyStruct.const_137,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_708)
            {
