package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1213,var_11);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_716 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_374,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_814,false,PropertyStruct.const_40,true) : PropertyDefaults.const_1625);
         _loc1_.push(this.var_1336 != PropertyDefaults.const_1088 ? new PropertyStruct(PropertyDefaults.const_912,this.var_1336,PropertyStruct.const_40,true) : PropertyDefaults.const_1624);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1100 ? new PropertyStruct(PropertyDefaults.const_775,_field.selectable,PropertyStruct.const_40,true) : PropertyDefaults.const_1734);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1138 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_40,true) : PropertyDefaults.const_1666);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_912:
                  this.var_1336 = _loc2_.value as Boolean;
                  if(this.var_1336)
                  {
               ...
               case PropertyDefaults.const_814:
                  ...
                  break;
               case PropertyDefaults.const_1309:
