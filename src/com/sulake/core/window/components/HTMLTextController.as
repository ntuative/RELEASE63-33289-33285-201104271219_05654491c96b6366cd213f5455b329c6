package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private var var_997:String = "default";
      
      private var var_1225:String = null;
      
      private var var_1889:StyleSheet = null;
      ...
      {
         if(PropertyDefaults.const_919.indexOf(param1) > -1)
         {
            this.var_997 = param1;
         }
      }
      ...
      {
         return this.var_997 == LinkTarget.const_30 ? defaultLinkTarget : this.var_997;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1889;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1135)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_997 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_968,this.var_997,PropertyStruct.const_56,true,PropertyDefaults.const_919));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_968)
            {
               this.var_997 = _loc2_.value as String;
               break;
            }
