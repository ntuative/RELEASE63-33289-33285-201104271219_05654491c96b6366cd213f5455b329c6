package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var var_373:Object = null;
      ...
      {
         return this.var_373 != null;
      }
      
      protected function get textField() : TextField
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_424);
         if(_loc1_)
         {
            _loc1_.text = this._text;
            if(this.var_373 != null)
            {
               _loc1_.textColor = uint(this.var_373);
            }
         }
         return _loc1_;
      }
      ...
      {
         if(this.var_424 != param1.name)
         {
            this.var_424 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2683 = _loc2_.textWidth;
         this.var_2682 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_373 != _loc2_.color : this.var_373 != null && this.var_373 != PropertyDefaults.const_898) ? new PropertyStruct(PropertyDefaults.const_399,this.var_373,PropertyStruct.const_143,true) : PropertyDefaults.const_1242);
         if(this.var_41)
         {
            if(this.var_41.left != PropertyDefaults.const_903)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_257,this.var_41.left,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_628);
            }
            if(this.var_41.top != PropertyDefaults.const_798)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_253,this.var_41.top,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_523);
            }
            if(this.var_41.right != PropertyDefaults.const_743)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_251,this.var_41.right,PropertyStruct.const_43,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_464);
            }
            if(this.var_41.bottom != PropertyDefaults.const_916)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_235,this.var_41.bottom,PropertyStruct.const_43,true));
            }
            else
            {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_399:
                  this.var_373 = _loc2_.value as uint;
                  break;
