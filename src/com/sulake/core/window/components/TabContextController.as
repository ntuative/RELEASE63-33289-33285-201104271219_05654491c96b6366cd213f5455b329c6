package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1458:String = "_SELECTOR";
      
      private static const const_1457:String = "_CONTENT";
       
      
      protected var var_1078:ITabSelectorWindow;
      
      protected var var_2135:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1078 = findChildByTag(const_1458) as ITabSelectorWindow;
            if(this.var_1078 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2135 = findChildByTag(const_1457) as IWindowContainer;
         }
      ...
      {
         return !!this.var_716 ? this.selector.iterator : null;
      }
