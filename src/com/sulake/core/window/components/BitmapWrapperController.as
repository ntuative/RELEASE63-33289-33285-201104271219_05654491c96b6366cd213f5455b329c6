package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_576 != PropertyDefaults.const_1233)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_952,this.var_576,PropertyStruct.const_40,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1637);
         }
         if(this.var_876 != PropertyDefaults.const_1163)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_938,this.var_876,PropertyStruct.const_56,true));
         }
         else
         {
