package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1099:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_415)
         {
            this.var_415.removeEventListener(WindowEvent.const_266,this.scrollBarEventProc);
            this.var_415.removeEventListener(WindowEvent.const_190,this.scrollBarEventProc);
            this.var_415 = null;
         }
         if(this.var_1099)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1099)
         {
            this.var_1099 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_415)
         {
            ...
            if(this.var_415)
            {
               this.var_415.addEventListener(WindowEvent.const_266,this.scrollBarEventProc);
               this.var_415.addEventListener(WindowEvent.const_190,this.scrollBarEventProc);
            }
         }
         return this.var_415;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_190)
         {
            this.hideScrollBar();
         }
      }
