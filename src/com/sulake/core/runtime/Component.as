package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1931:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1288:uint = 4;
       
      
      protected var var_806:uint = 0;
      
      protected var var_1325:String = "";
      
      protected var var_2118:String = "";
      ...
      private var var_487:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_487 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_487.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_487.getStructByInterface(param1);
         if(_loc2_ == null)
         {
         ...
         if(this.var_1453 & const_1288)
         {
            if(_loc3_ == 0)
            {
               if(this.var_487.getTotalReferenceCount() == 0)
               {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_806 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_487.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_487.getStructByIndex(_loc8_);
