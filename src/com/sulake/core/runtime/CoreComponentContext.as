package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1410:String = "asset-libraries";
      
      private static const const_1414:String = "library";
      
      private static const const_1409:String = "service-libraries";
      
      private static const const_1413:String = "library";
      
      private static const const_1412:String = "component-libraries";
      
      private static const const_1408:String = "library";
      
      private static const const_1407:String = "error_data";
      
      private static const const_1411:String = "error_cat";
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_819:
               ...
               var_403.addChild(new ProfilerViewer(this.var_208));
               break;
            case Core.const_468:
      ...
      {
         return this.var_518 - this.getNumberOfFilesPending();
      }
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1407,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1411,String(param3));
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         try
         {
            node = config.child(const_1410)[0];
            if(node != null)
            {
         ...
         try
         {
            node = config.child(const_1409)[0];
            if(node != null)
            {
               list = node.child(const_1413);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         try
         {
            node = config.child(const_1412)[0];
            if(node != null)
            {
               list = node.child(const_1408);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1553);
         if(!disposed)
         {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_789)
                  {
                     this.var_789.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_518 - this.var_356.length,this.var_518,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_208 ? 0 : this.var_1453 & 0;
         if(_loc3_ == Core.const_468)
         {
