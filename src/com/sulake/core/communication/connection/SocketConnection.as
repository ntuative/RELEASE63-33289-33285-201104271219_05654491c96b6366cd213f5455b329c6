package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1580:int = 10000;
      ...
      private var var_1171:IEncryption;
      
      private var var_785:IProtocol;
      
      private var _id:String;
      
      private var var_1172:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1172 = new MessageClassManager();
         this.var_81 = new Socket();
         this.var_354 = new Timer(const_1580,1);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1172.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         var _loc6_:ByteArray = this.var_785.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_516)
         {
            this.var_516.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1171 != null)
         {
            _loc3_ = this.var_1171.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1172.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_785.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_785.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1171 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_785.getMessages(this.var_517,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               eventClasses = this.var_1172.getMessageEventClasses(id);
               events = new Array();
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_517.writeByte(this.var_81.readUnsignedByte());
         }
      }
