package com.sulake.core.communication.messages
{
   ...
   public class MessageDataWrapper implements IMessageDataWrapper
   {
      ...
      private var var_1183:IProtocolDecoder;
      ...
      {
         return this.var_1183.readString(this._data);
      }
      
      public function readInteger() : int
      {
         return this.var_1183.readInteger(this._data);
      }
      
      public function readBoolean() : Boolean
      {
         return this.var_1183.readBoolean(this._data);
      }
      
      public function readShort() : Short
      {
         return this.var_1183.readShort(this._data);
      }
