package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return this.var_1459.indexOf(param1) > -1;
      }
               ...
               if(!this.containsIcon(_loc2_))
               {
                  ...
                  if(_loc5_.length() > 0)
                  {
                     ...
                     while(_loc9_ < _loc5_.length())
                     {
                        ...
                        _loc6_.dockMenu(_loc3_,this.getMenuYieldList(_loc3_),_loc5_[_loc9_].@locktoicon == "IHabboSoundManager");
                        _loc9_++;
                     }
                  }
                  else
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2526.elements("menu");
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_797.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      {
         return this.var_797.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1461.length)
         {
            _loc2_ = this.var_797.indexOf(this.var_1461[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_306[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1288 + _loc3_);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_306[this.var_797.indexOf(param1)];
      }
