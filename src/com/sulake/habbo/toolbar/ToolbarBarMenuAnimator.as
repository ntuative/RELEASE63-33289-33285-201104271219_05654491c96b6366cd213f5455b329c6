package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_232:Boolean = true;
      
      private static const const_1351:Number = 25;
      
      private static const const_1349:Number = 90;
      
      private static const const_1055:int = 50;
      
      private static const const_1467:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1553:IToolbarView;
      
      private var var_838:Timer;
      
      private var var_381:Array;
      
      private var _itemList:Object;
      
      private var var_675:Object;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:IToolbarView)
      {
         ...
         this.var_675 = new Object();
         this.var_677 = new Array();
         this.var_676 = new Array();
         super();
         this._windowManager = param1;
         this.var_1553 = param2;
         this.var_838 = new Timer(const_1351);
         this.var_838.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function animateWindowIn(param1:ToolbarIcon, param2:String, param3:IWindowContainer, param4:String, param5:Number, param6:String, param7:Array = null) : void
      {
         ...
         {
            this.method_2(param1,param2,param3,param4,param5,param7);
            return;
         }
      ...
      public function method_2(param1:ToolbarIcon, param2:String, param3:IWindowContainer, param4:String, param5:Number, param6:Array = null) : void
      {
         if(param3 == null)
         {
            return;
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_381[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_1055 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_1055 || param1.desktop.height - param1.y < const_1467;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1553.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_381.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1553.getIconLoc(param1.iconId);
      ...
      {
         return this.var_677[this.var_676.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_676[this.var_677.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_676.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_676.splice(_loc3_,1);
            this.var_677.splice(_loc3_,1);
         }
         this.var_677.push(param1.name);
         this.var_676.push(param2);
         param1.addEventListener(WindowEvent.const_241,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_190,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_675[_loc3_] == null)
            {
               this.var_675[_loc3_] = new Array();
            }
            if(this.var_675[_loc3_].indexOf(param1) < 0)
            {
               this.var_675[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_381.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_381.splice(this.var_381.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_677[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_676[_loc2_];
               if(this.var_675[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_675[_loc3_].length)
                  {
                     this.repositionWindow(this.var_675[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_381.length)
         {
            _loc2_ = this._itemList[this.var_381[_loc7_]];
            if(_loc2_.active)
            {
