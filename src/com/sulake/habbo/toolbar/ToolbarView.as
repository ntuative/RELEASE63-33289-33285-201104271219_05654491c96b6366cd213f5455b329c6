package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView implements IToolbarView
   {
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         this.var_234 = param2.createWindow("extrabar_container_window","",HabboWindowType.const_67,HabboWindowStyle.const_1160,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         this._window.tags.push("habbo_extrabar");
         if(param6.getKey("friendbar.enabled") == "IHabboSoundManager")
         {
         ...
         this.var_1261 = String(_loc9_.relocate_by_drag.@state) == "IHabboSoundManager";
         if(this.var_1261)
         {
         ...
         this.var_1262 = _loc9_.toolbar.@margin_top;
         this._toolbarMarginBottom = _loc9_.toolbar.@margin_bottom;
         this._toolbarMinGroupMargin = _loc9_.toolbar.@min_group_margin;
         this.var_1994 = _loc9_.toolbar.@margin_to_extrabar;
         this.var_309 = new ToolbarBarMenuAnimator(param2,this);
         var _loc10_:XMLList = XMLList(_loc9_.toolbar).children();
         var _loc11_:XMLList = XMLList(_loc9_.extras).children();
         this.createGroupsFromXmlList(_loc10_,this.var_273,param2,param3,param4,this._window,this.var_309);
         this.createGroupsFromXmlList(_loc11_,this.var_670,param2,param3,param4,this.var_234,this.var_309);
         this.alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         while(this.var_670.length > 0)
         {
            _loc1_ = this.var_670.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(this._window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_168,this.var_550,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_550);
         }
      }
      ...
      public function method_2(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.method_2(param1,param2,this.var_168,this.var_550);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_168,this.var_550);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_969);
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_234.x = this.var_168 + this.var_1994;
               this.var_234.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_234.x = 0;
               this.var_234.y = this.var_168 + this.var_1994;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1262;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_273.length > 1)
            {
               if(this.orientation == "LEFT" || this.orientation == "RIGHT")
               {
                  _loc6_ = Number(Math.max(this._toolbarMinGroupMargin,(this._window.height - _loc5_ * _loc8_ - this.var_1262 - this._toolbarMarginBottom) / (this.var_273.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this._toolbarMinGroupMargin,(this._window.width - _loc5_ * _loc8_ - this.var_1262 - this._toolbarMarginBottom) / (this.var_273.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_273.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_550;
