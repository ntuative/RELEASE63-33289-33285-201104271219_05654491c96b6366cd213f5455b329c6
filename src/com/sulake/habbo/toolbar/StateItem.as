package com.sulake.habbo.toolbar
{
   public class StateItem
   {
      ...
      private var var_216:int = 120;
      
      private var var_1954:String;
      
      private var var_1468:String = "-1";
      
      private var var_1617:String = "-1";
      
      private var var_1953:String = "-1";
      ...
      public function StateItem(param1:XML, param2:String)
      {
         ...
         {
            this.var_1435 = Boolean(param1.@loop);
         }
         if(param1.attribute("bounce").length() > 0)
         {
            this.var_2710 = Boolean(param1.@loop);
         }
         if(param1.attribute("timer").length() > 0)
         {
            this.var_216 = int(param1.@timer);
         }
         if(param1.attribute("namebase").length() > 0)
         {
            this.var_1954 = param1.@namebase;
         }
         else
         {
         ...
         {
            this.var_1617 = this._id;
         }
         if(param1.attribute("state_default").length() > 0)
         {
            this.var_1953 = param1.@state_default;
         }
         if(param1.attribute("tooltip").length() > 0)
         {
            this.var_2711 = param1.@tooltip;
         }
