package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private static const const_1496:String = "HELP";
      
      private static const const_1495:String = "ROOMINFO";
      ...
      private const const_523:int = 44;
      ...
      public function LogoutController(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.hideRoomInfo();
         this.var_2032 = this._config.getKey("roominfo.widget.enabled") == "1";
         if(this.var_2032)
         {
            this._events.addEventListener(HabboToolbarEvent.const_320,this.onRoomView);
            this._events.addEventListener(HabboToolbarEvent.const_318,this.onHotelView);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_2032)
         {
            this._events.removeEventListener(HabboToolbarEvent.const_320,this.onRoomView);
            this._events.removeEventListener(HabboToolbarEvent.const_318,this.onHotelView);
         }
         this._events = null;
         this._config = null;
         if(this._window)
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_464;
         _loc3_.y = this.const_523;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_684)
         {
            this.var_684 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1496);
               break;
            case "roominfo_region":
               this._toolbar.toggleWindowVisibility(const_1495);
               break;
            case "confirm":
               if(false)
               {
