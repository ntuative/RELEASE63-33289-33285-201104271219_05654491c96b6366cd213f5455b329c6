package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_753:String = "RCL_LOADER_READY";
      
      private static const const_365:String = "RCL_PUBLICROOM_";
      
      private static const const_1858:int = 0;
      ...
      private static const const_662:String = "wall_place_holder";
      
      private static const const_663:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_457;
      
      private static const const_664:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_1036:String = "selection_arrow";
      ...
      private var var_995:Map = null;
      
      private var var_435:Dictionary;
      
      private var var_994:Map = null;
      
      private var var_209:PublicRoomData = null;
      
      private var var_1498:Map = null;
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2654 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2657 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_428.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_531.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_531.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            _loc8_ = this.var_648.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_648.remove(_loc7_);
               this.var_648.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2655)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_753));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_530 != null)
         {
            this.var_530.remove(param1);
            this.var_530.add(param1,param2);
         }
         if(this.var_532 != null)
         {
            this.var_532.remove(param2);
            this.var_532.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_530 != null)
         {
            _loc2_ = this.var_530.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_324;
         }
         return RoomObjectCategoryEnum.const_185;
      }
      ...
      {
         return [const_457,const_662,const_663,const_664,TILE_CURSOR,const_1036];
      }
      ...
      {
         return this.var_995.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_994[param1];
         if(_loc3_ != null)
         {
      ...
      {
         if(this.var_209 != null && this.var_209.hasWorldType(const_365 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_243 || param1 == RoomObjectVisualizationEnum.const_73 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_433,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1498.getValue(param1) != null)
         {
            this.var_209 = this.var_1498.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_960,this.onContentLoaded);
            _loc6_ = 0;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1622);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_479,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_994.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1498.add(param1,_loc4_);
         this.var_209 = _loc4_;
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_531.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = this.var_531.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_531.add(_loc5_,_loc4_);
      ...
      {
         if(this.getObjectCategory(const_365 + param1) == RoomObjectCategoryEnum.const_80)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_209.getWorldHeightScale(const_365 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_209 != null)
         {
            return this.var_209.getWorldScale(const_365 + param1);
         }
         return 32;
      }
