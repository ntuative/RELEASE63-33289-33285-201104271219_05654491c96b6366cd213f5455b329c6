package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1464:String = "shore";
      ...
      {
         if(this.var_2746 == param1 && this.var_2747 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1464)
            {
               this.var_1991 = _loc2_;
               this.var_2746 = param1;
               this.var_2747 = direction;
               return this.var_1991;
            }
            _loc2_--;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_549 == 0 || this.var_669 == 0)
         {
            ...
            this.var_549 = _loc2_.getNumber(RoomObjectVariableEnum.const_357);
            this.var_669 = _loc2_.getNumber(RoomObjectVariableEnum.const_370);
         }
         this.var_444 = [];
         this.var_668 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_549 * 2 + this.var_669 * 2)
         {
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_70,getSize(param3),this.var_444,this.var_668,assetCollection);
      }
