package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      {
         if(param1 != this.var_2222)
         {
            if(!param1)
            {
               this.var_293.assign(this.var_730);
               this.var_292.assign(this.var_729);
            }
            else
            {
               this.var_293.assign(this.var_730);
               this.var_293.mul(this.var_729.length / this.var_730.length);
               this.var_292.assign(this.var_729);
               this.var_292.mul(this.var_730.length / this.var_729.length);
            }
            this.var_1680 = -1;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = Number(this.var_293.length * param1.scale);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_95 == null && this.var_1108 != null || this.var_293 == null || this.var_292 == null || this._normal == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1680)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1380 || _loc4_.y != this.var_2225 || _loc4_.z != this.var_2223 || param1.scale != this.var_2224))
            {
               this.var_1380 = _loc4_.x;
               this.var_2225 = _loc4_.y;
               this.var_2223 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1108);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_157.z - _loc7_,this.var_113.z - _loc7_,this.var_83.z - _loc7_,this.var_112.z - _loc7_);
               this.var_2221 = _loc8_;
