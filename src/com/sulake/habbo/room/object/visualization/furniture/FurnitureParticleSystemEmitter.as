package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1576:String = "plane";
      ...
      private var var_1018:Number = 0.1;
      ...
      public function setup(param1:int, param2:int, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:String, param8:Number, param9:int, param10:int) : void
      {
         ...
         this.var_271 = param6;
         this.var_2733 = param7;
         this.var_2728 = param9;
         this._energy = param8;
         this.var_2731 = param10;
         this.reset();
      }
      ...
      public function reset() : void
      {
         ...
         this.var_1019 = 0;
         this.var_969 = false;
         this.init(0,0,0,this._direction,this.var_2730,this.var_1018,this.var_2728,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1249.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_969 = true;
         if(this.var_1019 < this.var_1533)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2732)
         {
            switch(this.var_2733)
            {
               case const_1743:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_1018,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1249.length);
         return this.var_1249[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1019 < this.var_1533)
         {
            if(this.age % this.var_2731 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1019 < this.var_1533)
         {
            ...
            this.y = (2 - this.var_271) * this.y - (1 - this.var_271) * this.lastY + this.var_1975 * this.var_1018 * this.var_1018;
         ...
         for each(_loc2_ in this.var_376)
         {
            ...
            _loc2_.y = (2 - this.var_271) * _loc2_.y - (1 - this.var_271) * _loc2_.lastY + this.var_1975 * this.var_1018 * this.var_1018;
