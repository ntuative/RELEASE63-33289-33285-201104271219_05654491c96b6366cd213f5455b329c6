package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1823:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2239:Number = NaN;
      
      private var var_2241:int = -1;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1112:String = null;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1382 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1382;
            this.var_1382 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2244;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_473 != _loc3_.getUpdateID() || param1 != var_89 || param2 != this.var_2239)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2241 = _loc3_.getNumber(RoomObjectVariableEnum.const_259);
            ...
            this.var_1112 = this.getAdClickUrl(_loc3_);
            if(this.var_1112 == null || this.var_1112.indexOf("http") != 0)
            {
               this.var_1112 = null;
            }
            this.var_2244 = this.var_1112 != null;
      ...
      {
         if(this.var_2243 != param2 || this.var_2240 != param1)
         {
            this.var_909 = [];
            this.var_908 = [];
            this.var_742 = [];
            ...
            this.var_2242 = this.getSize(param1);
      ...
      {
         this.var_639 = param1;
         this.var_1688 = this.var_639 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_535.length)
         {
            return "";
         }
         var _loc3_:String = this.var_909[param2];
         var _loc4_:Boolean = this.var_908[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2242;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1688)
            {
               _loc6_ = FurnitureVisualizationData.const_535[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_909[param2] = _loc3_;
            this.var_908[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_737[param3] != null && !this.var_1687)
         {
            return this.var_737[param3];
         }
         if(this._data == null)
         {
            return LayerData.const_598;
         }
      ...
      {
         if(this.var_739[param2] != null)
         {
            return this.var_739[param2];
         }
         if(this._data == null)
         {
