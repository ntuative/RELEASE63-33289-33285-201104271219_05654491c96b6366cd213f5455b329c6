package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      protected function getAnimationId(param1:AnimationStateData) : int
      {
         ...
         if(_loc2_ != const_1226 && this._animationData.hasAnimation(this.var_519,_loc2_))
         {
            return _loc2_;
         }
         return const_1226;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_840);
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_840);
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this._animationData.isImmediateChange(this.var_519,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this._animationData.hasAnimation(this.var_519,_loc6_))
                  {
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_117 != null)
         {
            this.var_117.setLayerCount(this.var_639);
         }
      }
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_117.animationOver || this.var_963)
         {
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         var _loc11_:* = null;
         var _loc12_:int = 0;
         if(param1.animationOver && !this.var_963)
         {
            return 0;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(!_loc9_ || this.var_963)
            {
               ...
               if(this.var_963 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  _loc12_ = 0;
                  if(_loc11_ != null)
                  {
                  ...
                  if(_loc12_ == AnimationFrame.const_1262)
                  {
               ...
               if(_loc11_ == null || _loc11_.remainingFrameRepeats == AnimationFrame.const_568)
               {
                  _loc10_ = true;
                  _loc9_ = true;
               }
