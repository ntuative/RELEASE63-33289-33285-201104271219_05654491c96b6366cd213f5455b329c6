package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      private static const const_1381:int = 3;
      ...
      {
         return param1 + param2 * const_1381;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_147,const_82,const_66,const_147,const_82,const_66];
                     _loc8_ = [const_82,const_82,const_82,const_66,const_66,const_66];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
