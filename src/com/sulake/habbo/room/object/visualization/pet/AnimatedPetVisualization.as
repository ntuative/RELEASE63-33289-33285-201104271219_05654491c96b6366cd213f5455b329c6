package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1429:String = "head";
      
      private static const const_660:int = 1;
      
      private static const const_1032:int = 1000;
      
      private static const const_1427:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1427) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_282);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_140);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_282);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_1933 = _loc3_.getNumber(RoomObjectVariableEnum.const_369) > 0;
            ...
            {
               this.var_1853 = direction;
            }
            this.var_1476 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2289 = _loc3_.getNumber(RoomObjectVariableEnum.const_837);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_688);
            if(_loc9_ != this.var_1854)
            {
               this.var_1854 = _loc9_;
               this.var_2586 = this.var_1854.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_364 != null)
         {
            ...
            if(this.var_1476 > 0)
            {
               _loc2_ = param1 - this.var_1476;
               if(_loc2_ < const_1032)
               {
                  this.var_364.alpha = int(Math.sin(_loc2_ / const_1032 * 0) * 255);
      ...
      {
         return super.getAdditionalSpriteCount() + const_660;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2586);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_660)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_660))
            {
               if(param2 >= FurnitureVisualizationData.const_535.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_535[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1853);
         }
         return direction;
      }
      ...
      {
         if(this.var_981[param1] == null)
         {
            if(this._animationData.getTag(var_89,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1429)
            {
               this.var_981[param1] = true;
            }
            else
            {
               this.var_981[param1] = false;
            }
         }
