package com.sulake.habbo.room.object.visualization.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_236[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function calculateLength() : void
      {
         ...
         while(_loc1_ < this.var_236.length)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_446 += _loc2_.frameCount;
            }
            _loc1_++;
         }
      }
      ...
      public function getFrame(param1:int, param2:int) : AnimationFrame
      {
         ...
         var _loc3_:* = null;
         param2 /= this.var_2010;
         var _loc4_:Boolean = false;
         var _loc5_:int = 0;
         if(!this.var_1871)
         {
            _loc6_ = param2 / this.var_446;
            param2 %= this.var_446;
            if(this._loopCount > 0 && _loc6_ >= this._loopCount || this._loopCount <= 0 && this.var_446 == 1)
            {
               param2 = this.var_446 - 1;
               _loc4_ = true;
            }
            _loc7_ = 0;
            _loc5_ = 0;
            ...
            {
               _loc3_ = this.var_236[_loc5_] as AnimationFrameSequenceData;
               if(_loc3_ != null)
               {
         ...
         _loc5_ = this.var_236.length * Math.random();
         _loc3_ = this.var_236[_loc5_] as AnimationFrameSequenceData;
      ...
      {
         if(param2 < 0 || param2 >= this.var_236.length)
         {
            return null;
         }
         var _loc5_:AnimationFrameSequenceData = this.var_236[param2] as AnimationFrameSequenceData;
         if(_loc5_ != null)
         {
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:int, param4:int, param5:Boolean) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            _loc13_ = this.var_2010 * _loc12_;
            if(param5)
            {
               _loc13_ = 0;
            }
            _loc14_ = false;
            if(!this.var_1871 && !param2.isRandom)
            {
               if(param3 == this.var_236.length - 1 && param4 == param2.frameCount - 1)
               {
                  _loc14_ = true;
               }
            }
