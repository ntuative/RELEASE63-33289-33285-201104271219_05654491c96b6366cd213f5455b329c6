package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1669:int = const_408;
      ...
      public static const ALIGN_DEFAULT:int = const_128;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1.0, param5:Number = 1.0, param6:Number = -1.0, param7:Number = 1.0)
      {
         ...
         this.var_2725 = param7;
         if(this.var_1988 == const_713)
         {
            this.var_1990 = false;
         }
      }
         ...
         if(this.isStatic)
         {
            if(this.var_31 != null)
            {
               if(this.var_31.width == param2 && this.var_31.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_667,param6,param7);
                     return param1;
                  }
                  return this.var_31;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this._align == const_128)
         {
            _loc5_ = new Rectangle(0,0,this.var_31.width,this.var_667);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_31.height - this.var_667,this.var_31.width,this.var_667);
         }
