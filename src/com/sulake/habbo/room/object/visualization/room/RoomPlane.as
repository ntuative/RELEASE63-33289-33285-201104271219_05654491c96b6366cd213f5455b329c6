package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1108:Vector3d = null;
      ...
      private var var_1055:IPlaneRasterizer = null;
      
      private var var_731:PlaneMaskManager = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_1108 = new Vector3d();
         this.var_1108.assign(param1);
         ...
         this.var_2882 = param9;
         this.var_2879 = param10;
         this.var_2883 = param11;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1055.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_856 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_392))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_1055 != null)
            {
               _loc3_ = this.var_1055.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_2070,this.var_2882,this.var_2879,this.var_2883,this.var_2880,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1680 != geometry.updateId)
         {
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1352.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1352[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1108);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_157.z - originZ,this.var_113.z - originZ,this.var_83.z - originZ,this.var_112.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2221 = relativeDepth;
            this._isVisible = true;
            this.var_1680 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2881);
      ...
      {
         this.var_157.assign(param1.getScreenPosition(this.var_95));
         this.var_113.assign(param1.getScreenPosition(Vector3d.sum(this.var_95,this.var_292)));
         this.var_83.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_95,this.var_293),this.var_292)));
         this.var_112.assign(param1.getScreenPosition(Vector3d.sum(this.var_95,this.var_293)));
         this._offset = param1.getScreenPoint(this.var_1108);
         ...
         var _loc2_:Number = Math.min(this.var_157.x,this.var_113.x,this.var_83.x,this.var_112.x);
         var _loc3_:Number = Math.max(this.var_157.x,this.var_113.x,this.var_83.x,this.var_112.x);
         var _loc4_:Number = Math.min(this.var_157.y,this.var_113.y,this.var_83.y,this.var_112.y);
         var _loc5_:Number = Math.max(this.var_157.y,this.var_113.y,this.var_83.y,this.var_112.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_157 == null || this.var_113 == null || this.var_83 == null || this.var_112 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
         var _loc3_:Number = this.var_112.x - this.var_83.x;
         var _loc4_:Number = this.var_112.y - this.var_83.y;
         var _loc5_:Number = this.var_113.x - this.var_83.x;
         var _loc6_:Number = this.var_113.y - this.var_83.y;
         if(this._type == const_125 || this._type == TYPE_LANDSCAPE)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_125 || this._type == TYPE_LANDSCAPE))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_279.length == this.var_1057.length)
         {
            while(_loc1_ < this.var_279.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_1057[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_393.length > this.var_1589.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1056 || this.var_279.length == 0 && this.var_393.length == 0 && !this.var_392 || this.var_731 == null)
         {
            return;
         }
         ...
         if(this.var_392)
         {
            ...
            while(_loc5_ < this.var_279.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_70.width - this.var_70.width * _loc3_.leftSideLoc / this.var_293.length;
                  _loc11_ = this.var_70.height - this.var_70.height * _loc3_.rightSideLoc / this.var_292.length;
                  _loc12_ = _loc3_.type;
                  this.var_731.updateMask(this.var_70,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1057.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_393.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_70.width - this.var_70.width * _loc4_.leftSideLoc / this.var_293.length;
                  _loc11_ = this.var_70.height - this.var_70.height * _loc4_.rightSideLoc / this.var_292.length;
                  _loc13_ = this.var_70.width * _loc4_.leftSideLength / this.var_293.length;
                  _loc14_ = this.var_70.height * _loc4_.rightSideLength / this.var_292.length;
                  this.var_70.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1589.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_392 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_238.copyChannel(param1,param1.rect,const_681,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_238.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_238,this.var_238.rect,const_681,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
