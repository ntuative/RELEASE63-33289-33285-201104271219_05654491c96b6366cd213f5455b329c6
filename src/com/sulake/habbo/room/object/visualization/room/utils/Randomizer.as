package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2044:int = 16777216;
      ...
      private var var_1717:int = 16777216;
      
      private var var_2931:int = 69069;
      
      private var var_2930:int = 5;
      ...
      {
         var _loc1_:int = this.var_2931 * this.var_1718 + this.var_2930;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1717;
         this.var_1718 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1717 * param2);
      }
   }
}
