package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_1966:Number = 0.0;
      
      private var var_1245:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         this.var_265 = param1;
         this._height = param2;
         this.var_537 = this.var_265;
         this.var_539 = -1;
         this.var_538 = this._height;
         this.var_540 = -1;
         return true;
      }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         {
            _loc4_ = this.var_166[param2] as Array;
            ...
            {
               if(param1 == this.var_537 || param1 == this.var_539)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_538;
                  while(_loc6_ < this.var_540)
                  {
               ...
               if(param2 == this.var_538 || param2 == this.var_540)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_537;
      ...
      public function getTileHeight(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:Array = this.var_166[param2] as Array;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         var _loc7_:* = null;
         var _loc8_:int = 0;
         var _loc2_:Point = findEntranceTile(this.var_166);
         var _loc3_:int = 0;
         if(_loc2_ != null)
         {
         ...
         this.var_1003 = getFloorHeight(this.var_166);
         if(!param1)
         {
         ...
         var _loc5_:* = [];
         var _loc6_:int = 0;
         while(_loc6_ < this.var_166.length)
         {
            _loc4_ = this.var_166[_loc6_];
            _loc7_ = [];
            _loc8_ = 0;
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         this.addPlane(RoomPlaneData.const_361,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -this.var_1245);
         this.addPlane(RoomPlaneData.const_167,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_167,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_139) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_167,Vector3d.sum(param1,Vector3d.product(param3,-this.var_139 / param3.length)),Vector3d.product(param3,(param3.length + this.var_139) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,this.var_1245 / param2.length);
      ...
      {
         if(param1 == null || this.var_166 == null || param1 == this.var_166)
         {
            return false;
         }
         var _loc3_:int = 0;
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.length > this.var_166.length)
         {
            return false;
         }
         ...
         while(_loc3_ < _loc7_)
         {
            ...
            _loc6_ = this.var_166[_loc3_] as Array;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number) : void
      {
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_196,_loc13_,new Vector3d(0,0,-this.var_139),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_196,_loc13_,new Vector3d(0,0,-this.var_139),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_196,_loc13_,new Vector3d(0,0,-this.var_139),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_196,_loc13_,new Vector3d(0,0,-this.var_139),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1115;
         }
         var _loc2_:RoomPlaneData = this.var_138[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
