package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureTeaserLogic extends FurnitureLogic
   {
      ...
      private const const_2140:String = "TYPE_INJECTED";
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_153,RoomObjectFurnitureActionEvent.const_613];
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         else if(param1.type == MouseEvent.DOUBLE_CLICK)
         {
            if(eventDispatcher != null)
            {
               _loc7_ = object.getId();
               _loc8_ = object.getType();
               _loc9_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_613,_loc7_,_loc8_);
               eventDispatcher.dispatchEvent(_loc9_);
            }
         }
