package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_605,RoomObjectFurnitureActionEvent.const_602,RoomObjectFurnitureActionEvent.const_507,RoomObjectFurnitureActionEvent.const_555];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != this.var_2170)
         {
            this.var_2170 = _loc3_;
            if(_loc3_ == 1)
            {
