   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2433)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1441 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_837,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            _loc10_ = param1 as RoomObjectAvatarFigureUpdateMessage;
            _loc11_ = _loc2_.getString(RoomObjectVariableEnum.const_215);
            _loc2_.setString(RoomObjectVariableEnum.const_215,_loc10_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1765,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_688,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_211,_loc3_ + this.var_949);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1783;
            _loc2_.setNumber(RoomObjectVariableEnum.const_282,this.var_1783);
            _loc2_.setNumber(RoomObjectVariableEnum.const_140,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1782;
            _loc2_.setNumber(RoomObjectVariableEnum.const_140,this.var_1782);
         }
         else
         {
            this.var_949 += 45;
