package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1831:int = 255;
      
      private var var_1186:uint = 16777215;
      
      private var var_1830:int = 255;
      
      private var var_1185:int = 0;
      
      private var var_1829:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_603,RoomObjectMouseEvent.const_151];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1154,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_842,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_830,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_887,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1185)
         {
            ...
            if(_loc2_ - this.var_1185 >= this.var_1829)
            {
               _loc3_ = this.var_1186;
               _loc4_ = this.var_1830;
               this.var_1185 = 0;
            }
            else
            {
               ...
               _loc10_ = this.var_1186 >> 16 & 255;
               _loc11_ = this.var_1186 >> 8 & 255;
               _loc12_ = this.var_1186 & 255;
               _loc13_ = (_loc2_ - this.var_1185) / this.var_1829;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1831 + (this.var_1830 - this.var_1831) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_842,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_750:
               param2.setString(RoomObjectVariableEnum.const_202,param1.value);
               break;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_581:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_268)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_783:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1122,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1089:
               param2.setNumber(RoomObjectVariableEnum.const_830,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1300:
               param2.setNumber(RoomObjectVariableEnum.const_887,_loc3_);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1831 = this.var_1658;
         this.var_1186 = _loc3_;
         this.var_1830 = _loc4_;
         this.var_1185 = getTimer();
         this.var_1829 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_553,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1715,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1530,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1546,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_553,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_167 || _loc12_ == RoomPlaneData.const_361)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
