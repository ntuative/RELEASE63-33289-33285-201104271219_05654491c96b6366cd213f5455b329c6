package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_369 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201104271214));
         this._toolbar = param5;
         this.var_123 = new Map();
         this.var_123.add(HabboHelpViewEnum.const_1568,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         ...
         this.var_123.add(HabboHelpViewEnum.const_604,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_300,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_244,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_443,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_721,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_287,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_123.add(HabboHelpViewEnum.const_1203,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_123.add(HabboHelpViewEnum.const_1108,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_123.add(HabboHelpViewEnum.const_927,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_529.length == 0 || param1 != this.var_369)
            {
               this.var_529.push(this.var_369);
            }
         }
         this.var_369 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_287:
               ...
               break;
            case CallForHelpResultEnum.const_1170:
               this.showUI(HabboHelpViewEnum.const_1108);
               break;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_486));
      }
      ...
      {
         return this.var_123.getValue(this.var_369);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2651 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2653;
         this._window.width = _loc1_.width + this.var_2651;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_529.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_369 == HabboHelpViewEnum.const_216)
         {
            return;
         }
         ...
         var _loc2_:IBitmapWrapperWindow = this.var_370.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_369 == HabboHelpViewEnum.const_216 || this.var_529.length == 0)
         {
            return;
         }
         if(this.var_370 == null)
         {
            ...
            this.var_370 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_370.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_370.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_370 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_370 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_370 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
