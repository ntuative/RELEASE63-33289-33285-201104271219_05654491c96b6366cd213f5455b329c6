package com.sulake.habbo.help.enum
{
   ...
   public class HabboHelpTutorialEvent extends Event
   {
      ...
      public static const const_546:String = "HHTPNUFWE_LIGHT_CLOTHES_ICON";
      
      public static const const_486:String = "HHTPNUFWE_DONE_GUIDEBOT";
      
      public static const const_498:String = "HHTE_DONE_AVATAR_EDITOR_OPENING";
      
      public static const const_502:String = "HHTE_DONE_AVATAR_EDITOR_CLOSING";
