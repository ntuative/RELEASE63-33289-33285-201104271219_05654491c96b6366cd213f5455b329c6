package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1740:uint = 11129827;
      ...
      private var var_1131:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1742 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1069 || param1 == ChangeUserNameResultMessageEvent.var_1067)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1131 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1131.render(param3,_loc5_);
         var _loc7_:int = 0;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "header_button_close":
               this._controller.showView(TutorialUI.const_102);
         }
      }
