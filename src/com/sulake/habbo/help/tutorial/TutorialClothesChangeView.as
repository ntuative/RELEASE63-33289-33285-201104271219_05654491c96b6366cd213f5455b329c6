package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         this.var_34.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_58,this.onShowMenuEvent);
      ...
      {
         return TutorialUI.const_409;
      }
      
      public function dispose() : void
      {
         this.setToolbarIconHighlight(false);
         this.var_34.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_58,this.onShowMenuEvent);
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_58)
         {
            ...
            this.var_34.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_546));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_793 = this.var_34.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = this.var_793.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
         ...
         this.var_34.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_58,HabboToolbarIconEnum.MEMENU_ARROW,this.var_793));
      }
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_cancel":
               ...
               {
                  this.var_34.showView(TutorialUI.const_102);
               }
         }
      }
   }
