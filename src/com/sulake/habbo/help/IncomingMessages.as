   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != this._userId && _loc5_.userType == RoomObjectTypeEnum.const_180)
            {
               this.var_22.userRegistry.registerUser(_loc5_.webID,_loc5_.name);
            }
            if(_loc5_.webID == this._userId)
            {
               this.var_2518 = _loc5_.id;
            }
            _loc4_++;
         }
         this.var_22.tellUI(HabboHelpViewEnum.const_927);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showUI(HabboHelpViewEnum.const_604);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         this.var_22.tellUI(HabboHelpViewEnum.const_300,_loc6_);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showUI(HabboHelpViewEnum.const_1206);
         this.var_22.tellUI(HabboHelpViewEnum.const_1206,_loc5_);
      }
