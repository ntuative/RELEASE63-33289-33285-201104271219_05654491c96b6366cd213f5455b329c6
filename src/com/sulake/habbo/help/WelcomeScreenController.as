package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      {
         return this._notifications[this.var_1457];
      }
      ...
      public function dispose() : void
      {
         if(this.var_132)
         {
            ...
            this.var_132.toolbar.events.removeEventListener(HabboToolbarEvent.const_36,this.onToolbarClicked);
            this.var_132.toolbar.events.removeEventListener(HabboToolbarEvent.const_969,this.onToolbarResized);
            this.var_132 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_132.toolbar.events.addEventListener(HabboToolbarEvent.const_36,this.onToolbarClicked);
         this.var_132.toolbar.events.addEventListener(HabboToolbarEvent.const_969,this.onToolbarResized);
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_198.y = this.var_132.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
      ...
      {
         var _loc1_:XmlAsset = this.var_132.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_132.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
         ...
         _loc4_.content.setParamFlag(WindowParam.const_299,false);
         _loc4_.height -= 20;
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_104,this.current.targetIconId);
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1457 < this._notifications.length - 1)
         {
            ++this.var_1457;
         }
         else
