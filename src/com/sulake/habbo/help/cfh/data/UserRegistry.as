package com.sulake.habbo.help.cfh.data
{
   ...
   public class UserRegistry
   {
      ...
      private static const const_1326:int = 80;
      ...
      {
         var _loc4_:* = null;
         if(this.var_486.getValue(param1) != null)
         {
         ...
         this.var_486.add(param1,_loc4_);
         this.purgeUserIndex();
      }
      ...
      {
         var _loc1_:int = 0;
         while(this.var_486.length > const_1326)
         {
            _loc1_ = this.var_486.getKey(0);
            this.var_486.remove(_loc1_);
         }
      }
      ...
      private function addRoomNameForMissing() : void
      {
         ...
         {
            _loc1_ = this.var_486.getValue(this.var_1369.shift());
            if(_loc1_ != null)
            {
