package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeUI implements INameChangeUI
   {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         this.var_132.windowManager.alert("${generic.notice}","${help.tutorial.name.changed}",0,function(param1:IAlertDialog, param2:WindowEvent):void
         {
            param1.dispose();
         });
      }
      ...
      public function buildXmlWindow(param1:String, param2:uint = 1) : IWindow
      {
         ...
         return this.var_132.windowManager.buildFromXML(XML(_loc3_.content),param2);
      }
   }
}
