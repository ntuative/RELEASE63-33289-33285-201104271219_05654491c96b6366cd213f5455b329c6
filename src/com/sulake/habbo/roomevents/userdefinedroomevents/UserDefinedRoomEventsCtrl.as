package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1390:int = 2;
      ...
      private var var_1711:TriggerConfs;
      
      private var var_1709:ActionTypes;
      
      private var var_1710:ConditionTypes;
      
      private var var_246:Dictionary;
      
      private var var_35:Triggerable;
      
      private var var_749:RoomObjectHightLighter;
      
      private var var_132:UserDefinedRoomEventsHelp;
      
      private var var_1124:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1711 = new TriggerConfs();
         this.var_1709 = new ActionTypes();
         this.var_1710 = new ConditionTypes();
         this.var_246 = new Dictionary();
         super();
         this.var_80 = param1;
         this.var_749 = new RoomObjectHightLighter(param1);
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1124 = new SliderWindowController(this.var_80,IWindowContainer(this.find(this.var_51,"delay_slider_container")),this.var_80.assets,0,20,1);
         this.var_1124.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1124.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_749.hideAll(this.var_246);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_749.showAll(this.var_246);
         if(this.var_35 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_35);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1124.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1124.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = this.var_35.stuffTypeSelectionCode < 1 ? int(var_1390) : int(this.var_35.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.stuffTypeSelectionCode = (this.var_35.stuffTypeSelectionCode + 1) % (var_1390 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1709);
