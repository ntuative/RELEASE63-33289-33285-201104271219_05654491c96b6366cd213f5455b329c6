package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1211:Number = 1.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1211,param1);
         this.var_989 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_989);
         }
      ...
      {
         return int(this.var_1665 * (Number(param1 - this._minValue) / (this.var_1211 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1665 * (this.var_1211 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_990)
         {
            if(param1.type == WindowMouseEvent.const_52 || param1.type == WindowMouseEvent.const_210)
            {
               this.var_990 = false;
            }
         }
         if(!this.var_990 || param1.type != WindowEvent.const_241)
         {
            return;
         }
         if(this.var_643 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_643) * this.var_643;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_643 != 0)
            {
               _loc3_ = this.var_989 + this.var_643;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_725 != null)
            {
               ...
               this.var_1665 = _loc1_.width - _loc2_.width;
            }
         }
