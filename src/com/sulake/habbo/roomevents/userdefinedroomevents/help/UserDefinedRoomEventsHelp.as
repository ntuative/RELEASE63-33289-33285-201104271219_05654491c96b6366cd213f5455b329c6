package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1900 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1230 = this.var_1900.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1230)
         {
            this.var_1230.procedure = this.onButtonClick;
         }
         this.var_1229 = this.var_1900.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1229)
         {
            this.var_1229.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_268 >= this.var_60.length - 1)
         {
            this.var_1229.disable();
         }
         else
         {
            this.var_1229.enable();
         }
         if(this.var_268 <= 0)
         {
            this.var_1230.disable();
         }
         else
         {
            this.var_1230.enable();
         }
      }
      ...
      {
         ++this.var_268;
         this.var_268 = Math.min(this.var_268,this.var_60.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_60[this.var_268][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_60[this.var_268][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_60[this.var_268][1]).value;
