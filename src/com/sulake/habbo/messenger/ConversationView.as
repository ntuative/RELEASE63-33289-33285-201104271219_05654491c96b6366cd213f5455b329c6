package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1317:int = 10;
      
      private static const const_978:int = 100;
      ...
      private var var_2153:IScrollbarWindow;
      
      private var var_1628:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_136 = param1;
         this.var_1628 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this._list = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2153 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_978 + const_1316)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1317;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_479 == null || _loc1_.id != this.var_479.id)
         {
            this.var_479 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_479.followingAllowed)
         {
            this.var_1628.enable();
         }
         else
         {
            this.var_1628.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this._list.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_479.messages.length - const_978);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_479.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_479.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_705 || param3.type == Message.const_868 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_479.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_136.send(new FollowFriendMessageComposer(this.var_479.id));
      }
