package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1448:IEventDispatcher;
      
      private var var_1159:Boolean = false;
      
      private var var_1796:ProfilerOutput;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_206 = new Array(const_454);
         ...
         {
            this.var_206[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_274 = this.var_206[const_1401];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1796)
            {
               this.var_1796 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1796.profiler = _loc3_;
            this.var_1446 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1446);
            this.var_1447 = new ProfilerAgentTask("Redraw","Window rasterizer");
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_206)
            {
               ...
               {
                  IDisposable(this.var_206.pop()).dispose();
               }
            }
            this.var_206 = null;
            if(this.var_253)
      ...
      {
         return this.var_274.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_274.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_253[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_253[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this.var_206[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_206[param2].getDesktopWindow();
      ...
      {
         return this.var_206[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_206[param1].getDesktopWindow().getChildAt(this.var_274.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_206[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1448.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_454 - 1;
            while(_loc2_ >= 0)
            {
               this.var_206[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1159)
         ...
         this.var_1448.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_454)
         {
            this.var_206[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1159)
         {
         ...
         this.var_1448.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1722,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1543,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1565,param2.name + ": " + param2.toString());
            }
         }
      }
