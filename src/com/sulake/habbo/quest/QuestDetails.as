package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      public function onQuest(param1:QuestMessageData) : void
      {
         ...
         else if(this.var_340 == null || this.var_340.id != param1.id)
         {
            this.close();
         }
      }
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         var _loc6_:Boolean = this.var_340.type == "PLACE_ITEM" || this.var_340.type == "PLACE_FLOOR" || this.var_340.type == "PLACE_WALLPAPER";
