package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2146:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_428 = param5;
         this.var_428.events.addEventListener(BadgeImageReadyEvent.const_159,this.onBadgeImageReady);
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(this.var_985[_loc2_] == param1)
            {
               this.var_985.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_428.getBadgeImage(param1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = this.var_262[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < this.var_262.length)
               {
                  if((this.var_262[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(this.var_262[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
