package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_42:
               this.var_1517.setSelectedGridItem(this);
               this.var_1518 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1518 = false;
                  this.var_1517.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this.var_1525.color = !!this._isSelected ? uint(this.const_2142) : uint(this.const_2141);
      }
