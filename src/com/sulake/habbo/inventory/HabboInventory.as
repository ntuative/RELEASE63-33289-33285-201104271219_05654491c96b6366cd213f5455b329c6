package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1466:IncomingMessages;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            ...
            this.var_16.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_469,this.roomSessionEventHandler);
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_52.getValue(InventorySubCategory.const_309));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_52.getValue(InventoryCategory.const_734));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_52.getValue(InventoryCategory.const_332));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_52.getValue(InventoryCategory.const_382));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_52.getValue(InventoryCategory.const_156));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_52.getValue(InventoryCategory.const_378) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1466 = new IncomingMessages(this);
      ...
      {
         this.var_428 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionPropertyUpdateEvent.const_469,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_428 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_16 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_52.add(InventoryCategory.const_378,_loc1_);
         ...
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_428);
         this.var_52.add(InventoryCategory.const_332,_loc3_);
         ...
         this.var_52.add(InventoryCategory.const_734,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_428);
         this.var_52.add(InventoryCategory.const_382,_loc5_);
         ...
         this.var_52.add(InventorySubCategory.const_309,_loc6_);
         ...
         this.var_52.add(InventoryCategory.const_156,_loc8_);
         this.var_196 = true;
         if(this.var_2558)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_309:
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2144);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_740));
      }
