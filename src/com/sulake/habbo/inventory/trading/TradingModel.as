package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_330:uint = 3;
      
      public static const const_483:uint = 4;
      
      public static const const_288:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_57.updateItemList(this.var_840);
         this.var_57.updateItemList(this.var_1555);
      ...
      public function close() : void
      {
         if(this.var_857)
         {
            if(this._state != const_198 && this._state != const_288)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_841 + " OTHER: " + this.var_1273);
         ...
         {
            case const_198:
               if(param1 == const_194 || param1 == const_288)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_57.alertPopup(TradingView.const_1114);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_840)
            {
               this.var_841 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1273 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_57.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_840)
            {
               this.var_57.alertPopup(TradingView.const_1221);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_276.length < const_1807)
         {
