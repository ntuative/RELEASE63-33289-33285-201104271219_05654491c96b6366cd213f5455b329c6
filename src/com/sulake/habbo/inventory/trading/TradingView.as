package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1071:uint = 4284532064;
      ...
      private var var_696:ItemPopupCtrl;
      ...
      private var var_1066:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_696 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_2079 = this.createMinimizedWindow();
         }
         if(!this.var_2892)
         {
            return this.var_71;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_71)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.ownUserAccepts ? uint(const_1071) : uint(const_1072);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.otherUserAccepts ? uint(const_1071) : uint(const_1072);
            }
      ...
      public function removeSelection() : void
      {
         if(this.var_1066)
         {
            this.var_1066.isSelected = false;
            this.var_1066 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1732)
            {
            ...
            this.var_696.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_526);
            this.var_696.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_696.hideDelayed();
         }
      }
         ...
         if(this.var_195.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_18.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_18.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_696.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_526);
               }
            }
            else
            {
