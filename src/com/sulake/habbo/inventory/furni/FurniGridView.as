package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      private var var_252:IItemGridWindow;
      
      private var var_2977:XML;
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_252 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            this.var_252.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var _loc3_:IWindow = this.var_252.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function setLock(param1:Boolean) : void
      {
         if(param1)
         {
            this.var_252.autoArrangeItems = false;
            this.var_252.lock();
         }
         else
         {
            this.var_252.autoArrangeItems = true;
            this.var_252.unlock();
         }
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_42)
         {
            ...
            this.var_66.toggleItemSelection(this._category,this.var_252.getGridItemIndex(param1.window));
            this.var_603 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_603 != null && this.var_603 == param2 && !this.var_66.isTradingOpen)
         {
