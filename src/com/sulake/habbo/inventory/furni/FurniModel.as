package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private var var_1743:Vector.<Array>;
      
      private var var_1744:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_608 = new Timer(const_1374,1);
         ...
         this.var_2364 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_47)
            {
               ...
               {
                  this.var_1743 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1743;
            }
            else
            {
               if(this.var_1744 == null)
               {
                  this.var_1744 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1744;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_933 == null)
         {
            this.var_933 = this._windowManager.buildFromXML(this.var_2364) as IWindowContainer;
         }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_378);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_609.add(const_47,new Array());
         this.var_609.add(const_51,new Array());
         if(this._view != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_309;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_306 || _loc3_.category == FurniCategory.const_325 || _loc3_.category == FurniCategory.const_315)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_731)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
