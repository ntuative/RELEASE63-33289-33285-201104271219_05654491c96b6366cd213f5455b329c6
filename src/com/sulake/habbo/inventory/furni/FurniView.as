package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2170:int = 0;
      
      private const const_1035:int = 1;
      
      private const const_1855:int = 2;
      
      private const const_1856:int = 3;
      
      private const const_1887:int = 42;
      
      private const const_1888:int = 120;
      ...
      private var var_795:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_465.add(FurniModel.const_47,new FurniGridView(this.var_66,FurniModel.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_465.add(FurniModel.const_51,new FurniGridView(this.var_66,FurniModel.const_51,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_465.getValue(this.var_466);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_66.getCategoryContent(this.var_466);
         if(!this.var_66.isListInited())
         {
            _loc2_ = this.const_1035;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1855;
         }
         else
         {
            _loc2_ = this.const_1856;
         }
         if(this.var_2170 == _loc2_)
         {
            return;
         }
         this.var_2170 = _loc2_;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_66.getGroupItemInIndex(_loc3_,this.var_466);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_202);
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_206);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_795 && this.var_795.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1888)
         {
            _loc3_ = this.const_1888;
         }
         else if(_loc3_ < this.const_1887)
         {
            _loc3_ = this.const_1887;
         }
         else
         {
