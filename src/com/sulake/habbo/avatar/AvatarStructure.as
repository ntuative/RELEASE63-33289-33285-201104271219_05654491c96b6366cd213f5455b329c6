package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1020:AvatarActionManager;
      ...
      private var var_879:ActionDefinition;
      
      private var var_543:String;
      
      private var var_1535:PartOffsetData;
      ...
      {
         this.var_1535.loadOffsets(param1);
      }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         ...
         this.var_1020 = new AvatarActionManager(param1,this.var_543,param2);
         this.var_879 = this.var_1020.getDefaultAction();
      }
      ...
      {
         return this.var_1020.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_1020.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_1020.sortActions(param1);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_663[param1] = new Dictionary();
         }
         if(this.var_663[param1][param2])
         {
            return this.var_663[param1][param2];
         }
         this.var_663[param1][param2] = this.var_377.getMandatorySetTypeIds(param1,param2);
         return this.var_663[param1][param2];
      }
      ...
      {
         return this.var_1020.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1690[param3];
      ...
      {
         return this.var_1535.getOffset(param1,param2,param3,param4,param5,param6);
      }
