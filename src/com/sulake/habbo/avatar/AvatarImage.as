package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_613:AvatarFigureContainer;
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_1076)
         {
            ...
            if(this.var_808)
            {
               for each(_loc2_ in this.var_808)
               {
                  _loc2_.dispose();
               }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_264.length == 1 && this.var_88 == this.var_1853)
         {
            return this.var_88 + this.var_528 + this.var_641 % 4;
         }
         if(this.var_264.length == 2)
         {
            for each(_loc1_ in this.var_264)
            {
               ...
               {
                  return this.var_88 + this.var_528 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_641 % 11;
                  return this.var_88 + "_" + this.var_1853 + this.var_528 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2619 || param2 != this.var_2618 || param1 != this.var_2617)
         {
            this.var_2619 = param3;
            this.var_2618 = param2;
            this.var_2617 = param1;
            this.var_1868 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1335 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1335)
            {
               this.var_47.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_641);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_641);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_330.push(new ActiveActionData(param1,param2,this.var_641));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_879);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_528 = "";
         this.var_264 = this._structure.sortActions(this.var_330);
         if(this.var_264 == null)
         {
         ...
         {
            this.var_773 = this._structure.getCanvasOffsets(this.var_264,this._scale,this.var_88);
            for each(_loc4_ in this.var_264)
            {
               ...
               if(_loc4_.actionType == AvatarAction.const_344)
               {
                  ...
                  if(this.var_1487 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1487 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_264)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_880 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_349 || _loc1_.actionType == AvatarAction.const_254 || _loc1_.actionType == AvatarAction.const_376)
               {
                  this.var_880 = true;
               }
            }
