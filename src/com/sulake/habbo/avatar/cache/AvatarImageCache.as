package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1847:int = 60000;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_752 == GeometryType.const_1128 && param1 == GeometryType.const_1280 || this.var_752 == GeometryType.const_1280 && param1 == GeometryType.const_1128)
         {
            this.var_752 = param1;
            this.var_85 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_343.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_697)
                     {
                        if(_loc14_.action != null)
                        {
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1464.getFigure(),_loc5_,this.var_752,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_442 == null)
         {
            ...
            this.var_442 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_343);
            if(this.var_442 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_85)
         {
            this.var_85 = this._structure.getCanvas(this._scale,this.var_752);
            if(!this.var_85)
            {
               return null;
            }
            this.var_2336 = new Point(0,this.var_85.height - int(this.var_85.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1778[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_816 || _loc10_ == AvatarAction.const_376;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1403 = this.var_115.bodyPartId;
               this.var_182 = this.var_115.partType;
               this.var_1730 = this.var_115.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_115.flippedPartType != this.var_182)
                     {
                        this.var_182 = this.var_115.flippedPartType;
                     }
                  }
               }
               this.var_1404 = this._scale + "_" + this.var_115.action.assetPartDefinition + "_" + this.var_182 + "_" + this.var_1730 + "_" + _loc5_ + "_" + this._frame;
               this.var_425 = this._assets.getAssetByName(this.var_1404) as BitmapDataAsset;
               if(this.var_425 == null)
               {
                  this.var_1404 = this._scale + "_std_" + this.var_182 + "_" + this.var_1730 + "_" + _loc5_ + "_0";
                  this.var_425 = this._assets.getAssetByName(this.var_1404) as BitmapDataAsset;
               }
               if(!(!this.var_425 || !this.var_425.content))
               {
                  if(this.var_115.paletteMapId > -1)
                  {
                     this.var_956 = this._structure.renderManager.paletteManager.getPalette(this.var_115.paletteMapId);
                     if(this.var_956 != null)
                     {
                        this.var_927 = this.var_425.content as BitmapData;
                        this.var_183 = new BitmapData(this.var_927.width,this.var_927.height);
                        this.var_2337 = this.var_956.colorize(this.var_927.getPixels(this.var_927.rect));
                        this.var_183.setPixels(this.var_183.rect,this.var_2337);
                     }
                     else
                     {
                        this.var_183 = (this.var_425.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1403 == AvatarBodyPartType.const_261 || this.var_1403 == AvatarBodyPartType.const_1558 || this.var_1403 == AvatarBodyPartType.const_1600) && this.var_115.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_183.colorTransform(this.var_183.rect,this.var_115.color.colorTransform);
                  }
                  if(this.var_115.isBlendable)
                  {
                     this.var_183.colorTransform(this.var_183.rect,this.var_115.blendTransform);
                  }
                  this.var_928 = this.var_425.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_53)
                     {
                  ...
                  this.var_2335 = new ImageData(this.var_183,this.var_928,_loc7_);
                  this.var_926.push(this.var_2335);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_926,_loc6_);
         ...
         _loc8_ = this.var_926.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_926.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
