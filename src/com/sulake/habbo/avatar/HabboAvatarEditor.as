package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_1271:AvatarEditorHandler;
      ...
      private var var_1554:IHabboAvatarEditorDataSaver = null;
      ...
      {
         this.var_945 = FigureData.const_81;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_196)
         {
            ...
            _loc2_.loadAvatarData(const_1468,FigureData.const_81);
            _loc3_.loadAvatarData(const_1470,FigureData.FEMALE);
            this.var_101 = new Map();
            this.var_555 = new Map();
            this.var_101.add(AvatarEditorFigureCategory.const_748,new BodyModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_50,new HeadModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_261,new TorsoModel(this));
            this.var_101.add(AvatarEditorFigureCategory.const_714,new LegsModel(this));
            ...
            this.var_555.add(AvatarEditorSideCategory.const_109,new WardrobeModel(this));
            this.var_555.add(AvatarEditorSideCategory.const_562,new ClubPromoModel(this));
            this.var_196 = true;
         }
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_274 == null)
            {
               this.var_274 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_67,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_274.addChild(this._view.window);
               if(param5)
               {
                  this.var_274.center();
               }
            ...
            this.var_274.visible = !this.var_274.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_748);
         }
      ...
      {
         this.var_1032 = this.var_554.getFigureData(AvatarType.const_121);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1271 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_678[this.var_945];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1554 != null)
         {
            ...
            this.var_1554.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_2012;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1272 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1469)
                  {
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1573)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1272 >= _loc6_.clubLevel))
               {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1272 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_555.getValue(AvatarEditorSideCategory.const_109);
      }
