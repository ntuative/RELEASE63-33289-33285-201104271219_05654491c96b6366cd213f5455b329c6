package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1823:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_968.x = _loc11_;
            this.var_968.y = _loc12_;
            this.var_968.z = _loc13_;
         }
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_1822[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = this.var_1823.findAvatarSet(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:AvatarSet = this.var_1823.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = this.var_163[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_1822[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         for each(_loc7_ in _loc5_)
         {
            ...
            _loc9_ = _loc7_.getDistance(this.var_968);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            return _loc5_.getParts(this.var_1179,this.var_968,param4);
         }
         return [];
      }
