   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_39)
         {
            ...
            var_39["null"] = new AvatarEditorGridView(var_66,FigureData.const_242,_windowManager,_assetLibrary);
            var_39["null"] = new AvatarEditorGridView(var_66,FigureData.const_213,_windowManager,_assetLibrary);
         ...
         if(var_66 && var_148 == "")
         {
            var_66.switchCategory(FigureData.const_213);
         }
      }
