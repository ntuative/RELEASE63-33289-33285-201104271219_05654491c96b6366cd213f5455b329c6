package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_2115:int = 6710886;
      ...
      private var var_352:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1167 = [];
         this.var_1392 = [AvatarEditorFigureCategory.const_748,AvatarEditorFigureCategory.const_50,AvatarEditorFigureCategory.const_261,AvatarEditorFigureCategory.const_714,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_109];
         super();
         ...
         if(var_1605 == null)
         {
            ...
            var_1605 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_430 = new Timer(1000);
         this.var_430.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_430.stop();
            this.var_430.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_430 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1.length != this.var_1167.length)
         {
            return false;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2482 = this.canChangeOutfit();
            this.var_430.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_352 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_352.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_352.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1167.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_352.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_352.numSelectables)
               {
                  this.var_352.getSelectableAt(_loc6_).x = this.var_352.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_352.setSelected(this.var_352.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_44) && (this.var_1803 == AvatarEditorSideCategory.const_109 || this.var_2480))
         {
      ...
      {
         if(this.var_1803 == AvatarEditorSideCategory.const_109)
         {
            this.var_2480 = false;
            this.setSideContent(AvatarEditorSideCategory.const_894);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_894:
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_369 = param1;
         this.var_352.setSelected(this.var_352.getSelectableByName(param1));
      }
