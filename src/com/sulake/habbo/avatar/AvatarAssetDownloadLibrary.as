package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1898:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this.var_1504 = param3 + this.var_999 + ".swf";
         this.var_1504 = this.var_1504.replace("%revision%",this._revision);
      ...
      {
         this._state = var_1898;
         var _loc1_:URLRequest = new URLRequest(this.var_1504);
