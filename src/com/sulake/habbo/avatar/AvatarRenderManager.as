package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2139:String = "hd-99999-99999";
      ...
      private var var_778:PaletteManager;
      ...
      private var var_1791:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_571 = RenderMode.const_1602;
         ...
         this.var_107.add(AvatarType.const_121,_loc4_);
         ...
         this.var_107.add(AvatarType.const_73,_loc4_);
         ...
         this.var_778 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_303.init();
         this.var_778.init();
         _loc2_ = this.var_107.getValue(AvatarType.const_121) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_107.getValue(AvatarType.const_73) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_107.getValue(AvatarType.const_121) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_904)
         {
            if(this.var_2440 && this.var_2442 && this.var_2441)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_107.getValue(AvatarType.const_121) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1791)
         {
            this.var_1791 = new AvatarFigureContainer(this.const_2139);
         }
         this.var_226.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1791,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1542)
         {
            _loc6_ = !this.var_303.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_303.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_107.getValue(AvatarType.const_73) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_107.getValue(AvatarType.const_73);
      ...
      {
         var _loc3_:AvatarStructure = this.var_107.getValue(AvatarType.const_121) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_73:
               _loc3_ = this.var_107.getValue(AvatarType.const_73) as AvatarStructure;
               break;
            default:
