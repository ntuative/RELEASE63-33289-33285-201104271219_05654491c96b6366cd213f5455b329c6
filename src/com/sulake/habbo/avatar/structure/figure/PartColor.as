package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class PartColor implements IPartColor
   {
      ...
      public function PartColor(param1:XML)
      {
         ...
         this.var_2177 = parseInt(param1.@club);
         this.var_2178 = Boolean(parseInt(param1.@selectable));
         ...
         this.var_788 = new ColorTransform(this.var_1925,this.var_1924,this.var_1923);
      }
