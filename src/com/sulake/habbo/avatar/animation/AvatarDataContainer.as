package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1925:Number = 1.0;
      
      private var var_1924:Number = 1.0;
      
      private var var_1923:Number = 1.0;
      ...
      {
         super();
         this.var_1692 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2250 = parseInt(_loc2_,16);
         this.var_2251 = parseInt(_loc3_,16);
         this._rgb = parseInt(_loc2_,16);
         this.var_1828 = this._rgb >> 16 & 255;
         this.var_1827 = this._rgb >> 8 & 255;
         this._b = this._rgb >> 0 & 255;
         this.var_1925 = this.var_1828 / 255 * 1;
         this.var_1924 = this.var_1827 / 255 * 1;
         this.var_1923 = this._b / 255 * 1;
         if(this.var_1692 == 37)
         {
            this._alphaMultiplier = 0.5;
            this.var_2249 = false;
         }
         this.var_788 = new ColorTransform(this.var_1925,this.var_1924,this.var_1923,this._alphaMultiplier);
         this.var_1117 = this.generatePaletteMapForGrayscale(this.var_2251,this.var_2250);
      }
      ...
      {
         return this.var_1117.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1117.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1117.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1117.getValue("alphas") as Array;
      }
