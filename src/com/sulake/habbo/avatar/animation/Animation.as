package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1626:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1624 = String(param2.@desc);
         }
         else
         {
         ...
         if(param2.hasOwnProperty("sprite"))
         {
            ...
            {
               this.var_1350.push(new SpriteDataContainer(this as IAnimation,_loc3_));
            }
         }
         if(param2.hasOwnProperty("avatar"))
         {
            this.var_1623 = new AvatarDataContainer(param2.avatar[0]);
         }
         ...
         {
            this.var_1625 = new DirectionDataContainer(param2.direction[0]);
         }
         if(param2.hasOwnProperty("shadow"))
         {
            this.var_1626 = new ShadowDataContainer(param2.shadow[0]);
         }
         if(param2.hasOwnProperty("remove"))
         {
            for each(_loc5_ in param2.remove)
            {
               this.var_1348.push(String(_loc5_.@id));
            }
         }
         ...
         if(param2.hasOwnProperty("override"))
         {
            ...
            for each(_loc7_ in param2.const_639)
            {
               _loc8_ = _loc7_.@name;
               _loc9_ = _loc7_.@const_639;
               this.var_580.add(_loc9_,_loc8_);
               _loc10_ = new Array();
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc8_ in _loc7_.bodypart)
            {
               ...
               _loc10_ = new AnimationLayerData(param3,_loc8_,AnimationLayerData.const_697,_loc6_,_loc5_);
               _loc4_.push(_loc10_);
            }
      ...
      public function overridingAction(param1:String) : String
      {
         ...
         return this.var_580.getValue(param1);
      }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         {
            if(_loc4_.type == AnimationLayerData.const_697)
            {
      ...
      {
         return this.var_1625 != null;
      }
      
      public function hasShadowData() : Boolean
      {
         return this.var_1626 != null;
      }
