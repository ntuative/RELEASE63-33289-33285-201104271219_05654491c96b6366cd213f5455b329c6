package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_607:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:AlertView = var_607[this.var_1074] as AlertView;
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
      ...
      {
         var _loc1_:IFrameWindow = this._navigator.getXmlWindow(this.var_1074,2) as IFrameWindow;
