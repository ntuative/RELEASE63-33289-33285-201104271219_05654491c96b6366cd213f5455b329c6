package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_423:RoomInfoViewCtrl;
      
      private var var_1116:RoomCreateViewCtrl;
      ...
      private var var_2973:Dictionary;
      ...
      private var var_2247:RoomThumbnailRenderer;
      
      private var var_992:GuestRoomPasswordInput;
      
      private var var_296:GuestRoomDoorbell;
      
      private var var_1115:OfficialRoomEntryManager;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_423 = new RoomInfoViewCtrl(this);
         this.var_1116 = new RoomCreateViewCtrl(this);
         this.var_2247 = new RoomThumbnailRenderer(this);
         this.var_992 = new GuestRoomPasswordInput(this);
         this.var_296 = new GuestRoomDoorbell(this);
         this.var_438 = new Tabs(this);
         this.var_1115 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_339,HabboWindowStyle.const_45,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_423.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_36)
         {
            ...
            {
               this.var_423.handleToolbarEvent(param1);
            }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_58,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_294.startSearch(Tabs.const_293,Tabs.const_434,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_294.startSearch(Tabs.const_351,Tabs.const_248);
         this.var_438.getTab(Tabs.const_351).tabPageDecorator.tabSelected();
      }
