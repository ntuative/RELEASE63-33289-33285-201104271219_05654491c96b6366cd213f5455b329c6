package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1689:TextSearchInputs;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1689 == null)
         {
            ...
            this.var_1689 = new TextSearchInputs(this._navigator,false,_loc4_);
         ...
         {
            this.var_1689.searchStr.setText(this._navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.mainViewCtrl.startSearch(Tabs.const_293,Tabs.const_234,"-1",MainViewCtrl.const_786);
      }
