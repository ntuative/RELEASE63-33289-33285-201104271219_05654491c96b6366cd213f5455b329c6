package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1708 = IButtonWindow(this.find("obj_tab"));
         this.var_2280 = IWindowContainer(this.find("tile_grid"));
         this.var_2279 = IWindowContainer(this.find("now_editing_container"));
         ...
         Util.setProcDirectly(this.var_1708,this.onObjTabButton);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_66.mode = ThumbnailEditorModel.const_39;
         this.reload();
      }
      ...
      {
         this.setEnabled(this.var_1706,this.var_66.mode != ThumbnailEditorModel.const_39);
         this.setEnabled(this.var_1707,this.var_66.mode != ThumbnailEditorModel.const_63);
         this.setEnabled(this.var_1708,this.var_66.mode != ThumbnailEditorModel.const_35);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2279;
         Util.hideChildren(_loc1_);
         this.refreshEditImg(_loc1_,"edit_bg",this.var_66.mode == ThumbnailEditorModel.const_39);
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2280;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_639)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_67,HabboWindowStyle.const_30,HabboWindowParam.const_61,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_465,HabboWindowStyle.const_45,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_339,HabboWindowStyle.const_45,HabboWindowParam.const_61,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
