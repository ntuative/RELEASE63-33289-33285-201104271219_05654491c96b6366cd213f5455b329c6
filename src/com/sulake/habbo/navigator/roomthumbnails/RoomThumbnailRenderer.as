package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_639:int = 10;
      
      private static const const_990:int = 32;
      ...
      private function initScreenLocsByPositions() : void
      {
         ...
         this.var_2272 = _loc1_;
      }
      
      private function getLoc(param1:int, param2:int) : Point
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_990 / 2);
         return new Point(param1 * const_990 + _loc3_,param2 * const_1355);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_339,HabboWindowStyle.const_45,0 | (!!param3 ? HabboWindowParam.const_38 : HabboWindowParam.const_45),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_917.getImage(ThumbnailEditorModel.const_63,param2);
         if(_loc3_ == null)
         {
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         ...
         {
            this.var_1384 = this._navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(this.var_1384,this.var_1384.rect,new Point(0,0),null,null,true);
      }
      ...
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1353,_loc4_.y + const_1354 - _loc5_.height),null,null,true);
      }
