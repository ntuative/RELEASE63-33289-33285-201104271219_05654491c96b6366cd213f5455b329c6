package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         this.var_76.addEventListener(WindowKeyboardEvent.const_181,this.checkEnterPress);
         this.var_76.addEventListener(WindowEvent.const_105,this.checkMaxLen);
         this.var_2692 = this.var_76.textBackground;
         this._orgTextBackgroundColor = this.var_76.textBackgroundColor;
         this.var_2690 = this.var_76.textColor;
      }
      ...
      {
         this.var_76.textBackground = this.var_2692;
         this.var_76.textBackgroundColor = this._orgTextBackgroundColor;
         this.var_76.textColor = this.var_2690;
      }
      ...
      public function goBackToInitialState() : void
      {
         ...
         {
            this.var_76.text = this.var_1379;
            this.var_659 = true;
         }
         else
         {
      ...
      {
         return !this.var_659 && Util.trim(this.getText()).length > 2;
      }
      ...
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_76.text = this.var_2691;
         this.var_659 = false;
         this.restoreBackground();
      }
      ...
      private function checkMaxLen(param1:WindowEvent) : void
      {
         ...
         if(_loc2_.length > this.var_1940)
         {
            this.var_76.text = _loc2_.substring(0,this.var_1940);
         }
      }
   }
}
