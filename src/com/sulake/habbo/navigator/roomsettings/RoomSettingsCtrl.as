package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_434:IRoomSettingsCtrlOwner;
      ...
      private var var_1217:TextFieldManager;
      
      private var var_1215:ICheckBoxWindow;
      
      private var var_1220:ICheckBoxWindow;
      ...
      {
         this.var_368 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_368));
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1885 = true;
         this.var_434.roomSettingsRefreshNeeded();
      }
      ...
      {
         if(param1 != this.var_368 || this.var_1223 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1223 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1787)
         {
            this.var_811.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1803)
         {
            this.var_811.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1727)
         {
            this.var_1218.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1768)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1785)
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1218 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         ...
         this.var_1217 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1215 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1220 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1216 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         ...
         this.var_1222 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1221 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1884 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1495 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_267 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1219 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1494 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1494.mouseThreshold = 0;
         this.var_1494.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1219.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1884.visible = this._inRoom;
         if(this.var_812)
         {
         ...
         {
            this.populateForm();
            this.var_1222.visible = true;
            this.var_1495.visible = true;
            this._thumbnailContainer.visible = this._inRoom;
            this.var_1222.height = Util.getLowestPoint(this.var_1222) + 4;
         }
         this.var_1494.text = !!this.var_812 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this._thumbnailContainer.name,this.var_1222.name,this.var_1221.name,this.var_1495.name,this.var_1884.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1218.setText(_loc1_.description);
         this.var_992.setText("");
         this.var_1217.setText("");
         ...
         if(this.var_1220)
         {
            ...
            {
               this.var_1220.select();
            }
            else
            {
               this.var_1220.unselect();
            }
         }
         if(this.var_1216)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = this.var_1218.getText();
         ...
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_131)
         {
            ...
            _loc9_ = this.var_1217.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_992.clearErrors();
               this.var_1217.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowFoodConsume = this.var_1220.isSelected;
         _loc2_.allowWalkThrough = this.var_1216.isSelected;
         _loc2_.hideWalls = this.var_645.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_983,_loc2_.tags);
         this.addTag(this.var_984,_loc2_.tags);
         this.clearErrors();
         this.var_1223 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_368);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_75.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.method_9,[this.var_368]);
         _loc2_.show();
      }
      
      private function method_9(param1:WindowMouseEvent, param2:int) : void
      {
         var _loc3_:* = null;
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_179,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_67,HabboWindowStyle.const_30,HabboWindowParam.const_61,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_368));
      }
