package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2247 = new RoomThumbnailRenderer(param1);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_185,this.var_116);
         if(this.var_116.ownerName != "" && this.var_116.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_185,!!this.var_116.event ? this.getEventCtg(this.var_116.categoryId) : this.getRoomCtg(this.var_116.categoryId));
         this.refreshRoomDesc(this.var_185,this.var_116);
         this.refreshExtraCont();
         this.refreshInfo(this.var_185,"trading_allowed",this.var_116.allowTrading);
         this.refreshInfo(this.var_185,"doormode_doorbell",this.var_116.doorMode == 1);
         this.refreshInfo(this.var_185,"doormode_password",this.var_116.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_185,this.var_116.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1087.refreshTags(_loc1_,this.var_116.tags);
         ...
         this.var_2247.refreshThumbnail(_loc1_,this.var_116.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_293,Tabs.const_234,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
