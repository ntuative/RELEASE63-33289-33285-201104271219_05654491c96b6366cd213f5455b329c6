package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2594:ITextWindow;
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         this.var_1855.visible = true;
         this.var_2594.text = this._navigator.getText("roomevent_type_" + param1.eventType);
         ...
         this.var_1478.visible = true;
         this.var_1856.visible = false;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(this._window == null)
         {
            ...
            this.var_1855 = IWindowContainer(this.find("event_type_disabled_cont"));
            this.var_2594 = ITextWindow(this.find("event_type_disabled_text"));
            this.var_1856 = ITextWindow(this.find("create_caption"));
            this.var_1857 = ITextWindow(this.find("edit_caption"));
            this.var_1477 = IButtonWindow(this.find("create_button"));
            this.var_1479 = IButtonWindow(this.find("edit_button"));
            this.var_2593 = IButtonWindow(this.find("cancel_button"));
            this.var_1478 = IButtonWindow(this.find("end_button"));
            this.var_982 = IDropMenuWindow(this.find("event_type"));
            this.prepareEventTypes();
            Util.setProcDirectly(this.var_1477,this.onCreateButtonClick);
            Util.setProcDirectly(this.var_1479,this.onEditButtonClick);
            Util.setProcDirectly(this.var_1478,this.onEndButtonClick);
