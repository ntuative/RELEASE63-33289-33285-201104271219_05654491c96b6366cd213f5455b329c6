package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1415:CutToWidth = new CutToWidth();
      
      private static var var_1416:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1415.beforeSearch(param2,param1,param3);
         binarySearch(var_1415,param2.length - 1);
      }
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1416.beforeSearch(param2,param1,param3);
         binarySearch(var_1416,param2.length - 1);
      }
