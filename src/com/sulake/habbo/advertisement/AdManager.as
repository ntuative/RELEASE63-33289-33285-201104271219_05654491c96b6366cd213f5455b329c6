package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1285:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2824 = this._config.getKey("interstitial.enabled","false") == "IHabboSoundManager";
         this.var_2825 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2823 = int(this._config.getKey("interstitial.show.time","5000"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1287 == 0)
         {
            this.var_1287 = getTimer();
            return false;
         }
         if(this.var_2045 > 0 && this.var_2047 >= this.var_2045)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1287;
         if(_loc1_ > this.var_2825)
         {
            ++this.var_2047;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1577 = _loc2_.imageUrl;
         this.var_2822 = _loc2_.clickUrl;
         this.var_1287 = getTimer();
         if(this.var_1577 != "")
         {
            _loc3_ = this.var_1577;
            ...
            {
               this.var_237 = new Timer(this.var_2823,1);
            ...
            this.var_237.start();
            _loc4_ = new URLRequest(this.var_1577);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_608,0,0,param1.bitmapData,this.var_2822));
            this.var_1287 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_615));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1576 = _loc2_.imageUrl;
         this.var_2046 = _loc2_.clickUrl;
         if(this.var_1576 != "" && this.var_2046 != "")
         {
            _loc3_ = this.var_1576;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1576);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_539,0,0,_loc4_,_loc2_.assetName,this.var_2046,this.var_1286,this.var_1285));
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1285 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_686.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_686.add(_loc2_,_loc3_);
         }
         if(_loc3_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_686.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_849,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_686.remove(_loc2_.assetName);
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_711,_loc4_.roomId,0,null,_loc4_.imageUrl,_loc4_.clickUrl,null,null,_loc4_.objectId));
         }
      }
   }
}
