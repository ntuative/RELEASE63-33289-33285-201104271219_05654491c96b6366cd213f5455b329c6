package com.sulake.habbo.friendbar
{
   ...
   public class HabboFriendBar extends ComponentContext
   {
      ...
      private function onConfigurationAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         var _loc3_:* = this.var_184.getKey("friendbar.enabled") == "IHabboSoundManager";
         this.var_1132 = this.var_184.getKey("friend_bar.helper.friend_finding.enabled") == "IHabboSoundManager";
         var _loc4_:* = this.var_184.getKey("client.toolbar.static.enabled","false") == "IHabboSoundManager";
         if(_loc3_)
         {
