package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_677:String = "FriendBar";
      
      private static const const_676:String = "user_interaction";
      
      private static const const_1513:String = "visit_btn_click";
      
      private static const const_1511:String = "chat_btn_click";
      
      private static const const_1510:String = "find_friends_btn_click";
      
      private static const const_1064:String = "Toolbar";
      
      private static const const_1063:String = "open";
      
      private static const const_1065:String = "close";
      
      private static const const_1514:String = "FRIENDLIST";
      
      private static const const_1512:String = "MESSENGER";
       
      
      private var var_87:IHabboCommunicationManager;
      
      private var var_389:IHabboFriendList;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_389)
            {
               this.var_389.release(new IIDHabboFriendList());
               this.var_389 = null;
            }
            if(this.var_459)
            {
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_87)
         {
            ...
            this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_677,const_676,const_1513));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_459)
         {
            ...
            if(this.var_87)
            {
               this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_677,const_676,const_1511));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_87)
         {
            ...
            this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_677,const_676,const_1510));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         if(this.var_389)
         {
            ...
            {
               if(!this.var_389.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_389.openFriendRequests();
                  }
                  else
                  {
                     this.var_389.openFriendList();
                  }
               }
               else
               {
               ...
               if(this.var_87)
               {
                  this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1064,const_1514,!!this.var_389.isOpen() ? const_1063 : const_1065));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_459)
         {
            if(!this.var_459.disposed)
            {
               ...
               if(this.var_87)
               {
                  this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1064,const_1512,!!this.var_459.isOpen() ? const_1063 : const_1065));
               }
            }
         }
      }
      ...
      {
         this.var_389 = param2 as IHabboFriendList;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         for each(_loc8_ in _loc5_)
         {
            ...
            if(_loc3_)
            {
               ...
               this.var_146.splice(this.var_146.indexOf(_loc3_),1);
            }
         }
         ...
         {
            this.var_146 = !!const_294 ? this.sortByNameAndOnlineStatus(this.var_146) : this.sortByName(this.var_146);
         }
