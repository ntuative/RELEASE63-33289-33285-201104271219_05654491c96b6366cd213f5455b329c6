package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1907 = int(this.var_184.getKey("latencytest.interval"));
         this.var_1910 = int(this.var_184.getKey("latencytest.report.index"));
         this.var_2675 = int(this.var_184.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1909 > this.var_1907)
         {
            this.testLatency();
         }
      }
      ...
      private function testLatency() : void
      {
         ...
         this.var_652.add(this.var_1506,this.var_1909);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1506));
         ++this.var_1506;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_652 == null || this.var_229 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = this.var_652.getValue(_loc2_.requestId);
         this.var_652.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         this.var_229.push(_loc4_);
         if(this.var_229.length == this.var_1910 && this.var_1910 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1908) > this.var_2675 || this.var_1908 == 0)
            {
