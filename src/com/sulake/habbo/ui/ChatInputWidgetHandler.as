package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetChatInputWidgetMessage.const_867);
         _loc1_.push(RoomWidgetChatTypingMessage.const_767);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_867:
               _loc2_ = param1 as RoomWidgetChatInputWidgetMessage;
               if(_loc2_ != null)
               {
                  this.method_2(_loc2_.window);
               }
               break;
            case RoomWidgetChatTypingMessage.const_767:
      ...
      private function method_2(param1:IWindowContainer) : void
      {
         if(this._toolbar == null)
         {
            return;
         }
         this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_1136,HabboToolbarIconEnum.CHATINPUT,param1));
      }
