package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_719:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_413 != null)
         {
            ...
            {
               _loc2_ = this.var_413.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_290 != null)
         {
            ...
            {
               _loc2_ = this.var_290.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_480,RoomWidgetChatSelectAvatarMessage.const_703];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_480:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_44) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1272))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_44) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1272))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_703:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_290.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_413.getValue(_loc16_) as BitmapData;
                           }
                           ...
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_208)
                                    {
                                       this.var_290.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_413.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_719 == null)
            {
               ...
               this.var_485.y = 0;
               this.var_485.z = 0;
               this.var_719 = _loc4_.getScreenPoint(this.var_485);
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_719.x || _loc8_.y != this.var_719.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_719,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_290)
         {
            _loc2_ = this.var_290.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_413)
         {
            _loc2_ = this.var_413.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1093.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1646.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1646.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_290)
            {
               this.var_290.add(_loc3_,param2);
            }
         }
      }
   }
