package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_682,RoomWidgetStickieSendUpdateMessage.const_959,RoomWidgetStickieSendUpdateMessage.const_621];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_682:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_1254);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
                     ...
                     _loc11_ = new RoomWidgetStickieDataUpdateEvent(RoomWidgetStickieDataUpdateEvent.const_777,_loc2_.id,_loc3_.getType(),_loc9_,_loc8_,_loc10_);
            ...
            case RoomWidgetStickieSendUpdateMessage.const_621:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_959:
