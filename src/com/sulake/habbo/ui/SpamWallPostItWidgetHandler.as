package com.sulake.habbo.ui
{
   ...
   public class SpamWallPostItWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1902:IMessageEvent;
      ...
      {
         this.var_1902 = new RequestSpamWallPostItMessageEvent(this.onSpamWallPostItRequest);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1902);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this._disposed = true;
            this._connection.removeMessageEvent(this.var_1902);
      ...
      private function onSpamWallPostItRequest(param1:RequestSpamWallPostItMessageEvent) : void
      {
         ...
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetSpamWallPostItEditEvent(RoomWidgetSpamWallPostItEditEvent.const_619,_loc3_,_loc4_));
            }
         }
      }
      ...
      {
         return [RoomWidgetSpamWallPostItEditEvent.const_619,RoomWidgetSpamWallPostItFinishEditingMessage.const_683];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetSpamWallPostItFinishEditingMessage.const_683:
