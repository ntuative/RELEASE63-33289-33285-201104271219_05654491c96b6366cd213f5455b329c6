   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_740,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_911,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_546,this.onHelpTutorialEvent);
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_130,this.onHelpTutorialEvent);
            }
         ...
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_740,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_911,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_546,this.onHelpTutorialEvent);
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_130,this.onHelpTutorialEvent);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1351)
            {
               ...
               this.var_1627 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1627;
            }
         }
         if(this._toolbar != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1153,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_766);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_920);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_853);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_971);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_817);
         ...
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1648);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1214);
         _loc1_.push(RoomWidgetToolbarMessage.const_716);
         _loc1_.push(RoomWidgetToolbarMessage.const_922);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_414);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1809);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1166);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_933);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_958);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_719);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1532);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_746);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_947);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_792);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_438);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_958:
            ...
            case RoomWidgetWaveMessage.const_873:
               ...
               break;
            case RoomWidgetDanceMessage.const_766:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_920:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_853:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_971:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_397:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1237)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_710:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1299:
                        this._catalog.openCatalogPage(CatalogPageName.const_1524,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1152:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_332);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1764:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_78);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1781:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_817:
            ...
            case RoomWidgetToolbarMessage.const_716:
               ...
               break;
            case RoomWidgetToolbarMessage.const_922:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_489,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_414:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_498));
                  }
               }
               break;
            ...
            case RoomWidgetStoreSettingsMessage.const_746:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_396,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_947:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_396,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_792:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_502));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_438:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_770));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_687));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_130:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_130));
               break;
            case HabboHelpTutorialEvent.const_546:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_563));
         }
      }
