package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_871,RoomWidgetEcotronBoxOpenMessage.const_836,RoomWidgetEcotronBoxOpenedMessage.const_1667];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_871:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_836:
