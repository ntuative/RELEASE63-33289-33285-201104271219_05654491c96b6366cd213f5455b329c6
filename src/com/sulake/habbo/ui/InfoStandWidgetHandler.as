   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         if(this.var_67 != null)
         {
            ...
            this.var_67.events.addEventListener(SongInfoReceivedEvent.const_94,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_67 != null)
         {
            ...
            this.var_67.events.removeEventListener(SongInfoReceivedEvent.const_94,this.onSongInfoReceivedEvent);
            this.var_67 = null;
         }
         this.var_1076 = true;
         this.container = null;
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_759);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_824);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_806);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_886);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1742);
         _loc1_.push(RoomWidgetPetCommandMessage.const_484);
         ...
         _loc1_.push(RoomWidgetChangeMottoMessage.const_908);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_412 || param1.type == RoomWidgetUserActionMessage.const_572 || param1.type == RoomWidgetUserActionMessage.const_528)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_481:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_733,_loc3_.name);
            ...
            case RoomWidgetFurniActionMessage.const_707:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_759:
            ...
            case RoomWidgetRoomTagSearchMessage.const_824:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_806:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_886:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_319);
               _loc6_.id = param1.id;
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_388) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_388);
               }
               ...
               {
                  _loc25_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_298);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1186);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1097);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc29_ = "";
                  _loc30_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_828)
                  {
                  ...
                  {
                     _loc32_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_384.length);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_631)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc18_ != null)
               {
                  _loc15_.carryItem = _loc18_.getModel().getNumber(RoomObjectVariableEnum.const_558);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_134)
               {
                  _loc15_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_111)
               {
                  ...
                  if(_loc18_ != null)
                  {
                     _loc39_ = _loc18_.getModel().getString(RoomObjectVariableEnum.const_895);
                  ...
                  if(!_loc35_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_869;
                  }
                  if(!_loc36_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_769;
                  }
      ...
      {
         return [RoomSessionUserBadgesEvent.const_163];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_163:
