package com.sulake.habbo.ui
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1463:String = "hr-165-45.hd-208-2.ch-250-64.lg-285-82.sh-290-64";
      
      private static const const_1462:String = "hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_890,RoomWidgetClothingChangeMessage.const_438,RoomWidgetAvatarEditorMessage.const_414];
      }
            ...
            case RoomWidgetClothingChangeMessage.const_438:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     _loc9_ = "null";
                     _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_1218);
                     if(_loc10_ == null)
                     {
                        _loc10_ = const_1463;
                     }
                     ...
                     {
                        _loc9_ = "null";
                        _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_1190);
                        if(_loc10_ == null)
                        {
                           _loc10_ = const_1462;
                        }
                     }
                     if(this._container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_261,AvatarEditorFigureCategory.const_714],true))
                     {
                        _loc11_ = 0;
