package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private static const const_1318:int = 1000;
      ...
      private var var_1086:IRoomWidgetFactory = null;
      ...
      private var var_2160:uint = 16777215;
      ...
      private var var_1633:Rectangle;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_433,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_479,this.onRoomContentLoaded);
      ...
      public function set toolbar(param1:IHabboToolbar) : void
      {
         ...
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_536,this.onToolbarRepositionEvent);
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_36,this.onHabboToolbarEvent);
      }
      
      public function set layout(param1:XML) : void
      {
         this.var_197.setLayout(param1,this._windowManager,this._config);
         if(this._toolbar != null)
         {
            this.var_197.toolbarSize = this._toolbar.size;
            this.var_197.toolbarOrientation = this._toolbar.orientation;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_715.length)
            {
               _loc6_ = this.var_715.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_433,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_479,this.onRoomContentLoaded);
         ...
         {
            this._toolbar.events.removeEventListener(HabboToolbarEvent.const_536,this.onToolbarRepositionEvent);
         ...
         {
            this.var_480.reset();
            this.var_480.removeEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
            this.var_480 = null;
         }
         this.var_1633 = null;
      }
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_30 != null)
         {
            this.var_713 = this._roomEngine.loadRoomResources(this.var_30.roomResources);
         ...
         if(this.var_324 != null && this.var_30.state == RoomSessionEvent.const_256)
         {
            this.var_1632 = !this.var_324.showInterstitial();
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1086.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_197.addWidgetWindow(param1,_loc2_.mainWindow);
         ...
         if(_loc4_ != null)
         {
            ...
            if(!this.var_715.add(param1,_loc4_))
            {
               _loc4_.dispose();
            }
            _loc8_ = null;
            ...
            if(_loc9_ != null)
            {
               ...
               {
                  _loc8_ = this.var_714.getValue(_loc11_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_714.add(_loc11_,_loc8_);
                  }
                  else
                  {
            ...
            if(_loc10_ != null)
            {
               ...
               {
                  _loc8_ = this.var_712.getValue(_loc12_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_712.add(_loc12_,_loc8_);
                  }
                  _loc8_.push(_loc4_);
               }
            }
         ...
         {
            param1 = "null";
            _loc13_ = new RoomWidgetRoomViewUpdateEvent(param1,this.var_197.roomViewRect);
      ...
      private function isFurnitureSelectionDisabled(param1:RoomEngineObjectEvent) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               {
                  _loc2_ = true;
                  if(this.var_428.isAnyRoomController)
                  {
                     _loc2_ = false;
                  }
               }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.ROOM_OBJECT_SELECTED:
               ...
               if(this.var_1047 != null && _loc3_ == RoomObjectCategoryEnum.const_34)
               {
                  _loc7_ = this.var_30.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_180)
                  {
                     this.var_1047.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_385:
               ...
               break;
            case RoomEngineObjectEvent.const_813:
               switch(_loc3_)
               {
                  case RoomObjectCategoryEnum.const_27:
                  case RoomObjectCategoryEnum.const_26:
            ...
            case RoomEngineObjectEvent.const_571:
               ...
               break;
            case RoomEngineObjectEvent.const_850:
               if(!this.var_30.isRoomController && !this.var_428.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_141:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1112,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_155:
               ...
               this.processWidgetMessage(_loc5_);
               break;
            case RoomEngineSoundMachineEvent.const_255:
               this.processEvent(param1);
         }
         if(_loc4_ != null)
         {
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_520:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_98,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineEvent.const_467:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_436,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_896);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_965);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_855);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_30.roomId,this.var_30.roomCategory,RoomVariableEnum.const_776);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2160);
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this.var_1633 = _loc2_.rectangle;
         this._roomEngine.modifyRoomCanvas(this.var_30.roomId,this.var_30.roomCategory,this.var_289[0],_loc2_.width,_loc2_.height);
         if(this.var_480 == null)
         {
            this.var_480 = new Timer(const_1318,1);
            this.var_480.addEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
         }
         else
         {
            this.var_480.reset();
      ...
      private function onResizeTimerEvent(param1:TimerEvent) : void
      {
         ...
         this.events.dispatchEvent(new RoomWidgetRoomViewUpdateEvent(_loc2_,this.var_1633));
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1631) / 1000);
      ...
      {
         if(this.var_16 != null && this.var_30 != null && this.var_1632 && this._loadingComplete)
         {
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_525:
               ...
               this.var_219 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_435,WindowStyle.const_1105,WindowParam.const_106) as IToolTipWindow;
