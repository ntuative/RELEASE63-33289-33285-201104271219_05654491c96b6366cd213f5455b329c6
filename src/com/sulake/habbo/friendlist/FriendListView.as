package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1838:String = "noconvinfo";
      
      private static const const_1839:String = "messageinput";
      ...
      private var var_1378:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList, param2:IHabboConfigurationManager)
      {
         ...
         this.var_1378 = new FriendListTabsView(this._friendList);
         if(param2.getKey("client.toolbar.static.enabled","false") == "IHabboSoundManager")
         {
            this.var_1046 = true;
         }
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_1008 = IWindowContainer(this.var_15.content.findChildByName("main_content"));
         this.var_272 = IWindowContainer(this.var_15.content.findChildByName("footer"));
         this.var_1378.prepare(this.var_1008);
         this.var_15.procedure = this.onWindow;
         this.var_15.content.setParamFlag(HabboWindowParam.const_1142,false);
         this.var_15.content.setParamFlag(HabboWindowParam.const_1222,true);
         this.var_15.header.setParamFlag(HabboWindowParam.const_803,false);
         this.var_15.header.setParamFlag(HabboWindowParam.const_737,true);
         this.var_15.content.setParamFlag(HabboWindowParam.const_803,false);
         this.var_15.content.setParamFlag(HabboWindowParam.const_737,true);
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1679 == -1 ? 0 : int(this.var_15.height - this.var_1679);
         var _loc4_:int = this.var_1677 == -1 ? 0 : int(this.var_15.width - this.var_1677);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_272.y = Util.getLowestPoint(this.var_15.content);
         ...
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1259,this._friendList.tabs.findSelectedTab() != null);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_803,false);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1142,false);
         ...
         this.var_1679 = this.var_15.height;
         this.var_1677 = this.var_15.width;
