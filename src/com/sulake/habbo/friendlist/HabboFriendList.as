package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_822:ISessionDataManager;
      
      private var var_2708:FriendListLookAndFeel;
      
      private var var_438:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1950:OpenedToWebPopup;
      ...
      private var var_1951:AvatarSearchResults;
      ...
      {
         this.var_2708 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_101 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1951 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_660.stop();
            this.var_660.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_660 = null;
         }
         ...
         if(this.var_1125)
         {
            this.var_1125.release(new IIDAvatarRenderManager());
            this.var_1125 = null;
         }
         ...
         if(this.var_822)
         {
            this.var_822.release(new IIDSessionDataManager());
            this.var_822 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1950 = new OpenedToWebPopup(this);
         }
         this.var_1950.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_359);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_339,HabboWindowStyle.const_45,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1125.createAvatarImage(param1,AvatarScaleType.const_96,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "IHabboSoundManager";
      }
      ...
      {
         this.var_822 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_1255,this.getText("friendlist.friends")));
         this.var_101.addCategory(new FriendCategory(FriendCategory.const_392,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_660)
         {
            this.var_660 = new Timer(120000);
            this.var_660.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_660.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_101.findCategory(FriendCategory.const_392);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_438.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_402));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_438.findTab(FriendListTab.const_101).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_438.findTab(FriendListTab.const_101);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1951.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_438.findTab(FriendListTab.const_101);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_822 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_822.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_822.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_44))
         {
