package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1850:String = "no_reqs_info";
      ...
      private var var_1788:IContainerButtonWindow;
      ...
      {
         this.var_1787 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1788 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1788.procedure = this.onDismissAllButtonClick;
         this.var_1787.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_182)
         {
         ...
         else if(param1.state == FriendRequest.const_418)
         {
            this._friendList.refreshText(_loc2_,"info_text",true,"${friendlist.request.declined}");
         }
         else if(param1.state == FriendRequest.const_1252)
         {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_418;
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_437 && _loc4_.state != FriendRequest.const_418)
            {
               _loc4_.state = FriendRequest.const_418;
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1788,_loc1_);
      }
