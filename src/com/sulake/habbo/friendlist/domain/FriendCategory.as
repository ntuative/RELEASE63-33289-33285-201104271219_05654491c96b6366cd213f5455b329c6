package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         if(this.var_971 >= this.getPageCount())
         {
            this.var_971 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_227.length / const_425);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_971 * const_425;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_971 + 1) * const_425,this.var_227.length);
      }
