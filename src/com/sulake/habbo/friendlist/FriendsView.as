package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_1950:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2828:IContainerButtonWindow;
      
      private var var_2827:IContainerButtonWindow;
      
      private var var_2829:IContainerButtonWindow;
      
      private var var_2755:IContainerButtonWindow;
      
      private var _list:IItemListWindow;
      
      private var var_696:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_696 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2828 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2827 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2829 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2755 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2828,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2827,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2829,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2755,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_696.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_696.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_696.closePopup();
         }
