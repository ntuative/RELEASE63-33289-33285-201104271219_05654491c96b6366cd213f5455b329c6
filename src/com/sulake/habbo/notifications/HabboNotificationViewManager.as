package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      public function showItem(param1:HabboNotificationItem) : Boolean
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_2695,this.var_410,this._toolbar,param1);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_634 < 540;
      }
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         var _loc1_:int = this.var_1520;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_191.length)
         {
            _loc3_ = this.var_191[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_634 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_634 + const_1049;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      {
         var _loc4_:* = null;
         this.var_1520 = const_1442 + param1;
         var _loc2_:int = this.var_1520;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_191.length)
         {
            _loc4_ = this.var_191[_loc3_] as HabboNotificationItemView;
            _loc4_.reposition(_loc2_);
            _loc2_ = _loc4_.verticalPosition + HabboNotificationItemView.const_634 + const_1049;
            _loc3_++;
         }
      }
   }
