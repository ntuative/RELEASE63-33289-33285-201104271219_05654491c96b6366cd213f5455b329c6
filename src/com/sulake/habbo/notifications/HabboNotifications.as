package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1448:String = "pixelbalance";
      
      private static const const_1447:String = "badges";
      
      private static const const_1446:String = "selectbadge";
      
      private static const const_1445:String = "inventory";
      
      private static const const_1450:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1449:String = "friendlist";
      
      private static const const_1444:String = "pet_inventory";
      
      private static const const_1443:String = "go_to_room";
      ...
      private var var_824:IHabboToolbar;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1012);
         }
         var _loc6_:Map = this.var_1012["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_824)
         {
            this.var_824.release(new IIDHabboToolbar());
            this.var_824 = null;
         }
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1012["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1243.push(_loc8_);
         return this.var_1243.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1243.splice(0,1);
      ...
      {
         this.var_824 = IHabboToolbar(param2);
         this.var_824.events.addEventListener(HabboToolbarEvent.const_71,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_71)
         {
            ...
            this.var_375 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_1012["styles"],this.var_1012["view"],this.var_824);
            ...
            this.var_428.events.addEventListener(BadgeImageReadyEvent.const_159,this.onBadgeImage);
            this.var_824.events.addEventListener(HabboToolbarEvent.const_536,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1523[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_428);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1523[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1523[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_428.userId == _loc2_.userId)
         {
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1710,null);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_554.createAvatarImage(param2,AvatarScaleType.const_53);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_428.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_65)
               {
                  _loc7_ = this.var_428.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_428.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1655,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1253)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1681,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1774)
         {
      ...
      {
         var _loc2_:* = null;
         if(this.var_375.isSpaceAvailable() && this.var_1243.length > 0)
         {
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1082,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1082,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_554.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_53);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2709)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1220,null);
            this.var_2709 = true;
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_1220,_loc6_);
      }
   }
}
