package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_634:int = 70;
      ...
      private static const const_979:int = 3;
      
      private static const const_446:Number = 50;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1642 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1642 = 15;
         }
         this.var_1640 = this._window.height;
         this.var_717 = 4;
         this.var_718 = 0;
         this._state = name_3;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_490:
               ...
               _loc2_ = Number(this.var_1089) / Number(this.var_410["time_fade_in"]);
               if(this.var_1089 > int(this.var_410["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_980:
               ...
               if(this.var_1363 > int(this.var_410["time_display"]) && !this.var_1641)
               {
                  this.startFadeOut();
               }
               break;
            case const_979:
               ...
               _loc3_ = 1 - Number(this.var_1088) / Number(this.var_410["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1088 > int(this.var_410["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1642;
         if(this._window.height < this.var_1640)
         {
            this._window.height = this.var_1640;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this._toolbar.orientation == "TOP" ? int(const_446) : 0;
         var _loc4_:int = this._toolbar.orientation == "BOTTOM" ? int(_loc2_.height - const_446) : int(_loc2_.height);
         var _loc5_:int = this._toolbar.orientation == "LEFT" ? int(const_446) : 0;
         var _loc6_:int = this._toolbar.orientation == "RIGHT" ? int(_loc2_.width - const_446) : int(_loc2_.width);
         if(this.var_410["position_horizontal_follow_toolbar"] == "IHabboSoundManager" && (this._toolbar.orientation != "TOP" && this._toolbar.orientation != "BOTTOM"))
         {
         ...
         if(this.var_410["position_vertical_follow_toolbar"] == "IHabboSoundManager" && (this._toolbar.orientation != "RIGHT" && this._toolbar.orientation != "LEFT"))
         {
            if(this._toolbar.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_717;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_717;
            }
         }
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_718;
      }
   }
}
