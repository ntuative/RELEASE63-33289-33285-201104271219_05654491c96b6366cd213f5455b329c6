package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1848:String = "badge_bg_001_png";
      
      private const const_2135:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_60 = param10;
         this._assets = param8;
         this.var_428 = param13;
         this._communication = param12;
         param13.events.addEventListener(BadgeImageReadyEvent.const_159,this.onBadgeImageReady);
         ...
         this._window.center();
         this.var_2395 = this.var_60.getBadgeName(this.var_300);
         this.var_2397 = this.var_60.getBadgeDesc(this.var_300);
         this.var_2398 = this.var_60.getAchievementNameForFacebook(this.var_300,this.var_428.userName,this.var_428.realName,this.var_1427);
         this.var_2399 = this.var_60.getAchievementDescForFacebook(this.var_300,this.var_428.userName,this.var_428.realName,this.var_1427);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2396 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_60.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_2005.toString());
         this.var_60.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1428.toString());
         this.var_60.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1428.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1767;
         var _loc17_:String = this.var_1767 == 0 ? "pixels" : "activitypoints";
         this.var_60.registerParameter(_loc16_,_loc17_,"" + this.var_2265);
         _loc15_.caption = this.var_60.getKey(_loc16_);
         this._window.findChildByName("achievement_info").caption = this._desc;
         this.setBadge(param13.getBadgeImage(param1),this.const_1848);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2135) as BitmapDataAsset).content as BitmapData;
      ...
      {
         this.var_60.registerParameter(param1,"badge_name",this.var_2395);
         this.var_60.registerParameter(param1,"badge_desc",this.var_2397);
         this.var_60.registerParameter(param1,"badge_name_fb",this.var_2398);
         this.var_60.registerParameter(param1,"badge_desc_fb",this.var_2399);
         this.var_60.registerParameter(param1,"level",this.var_1427.toString());
         this.var_60.registerParameter(param1,"name",this.var_428.userName);
         return this.var_60.registerParameter(param1,"realname",this.var_428.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_428.events.removeEventListener(BadgeImageReadyEvent.const_159,this.onBadgeImageReady);
            this.var_428 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         this.setBadge(param1.badgeImage,this.const_1848);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_300,this._feedTitleFb,this.var_2396,param1);
      }
