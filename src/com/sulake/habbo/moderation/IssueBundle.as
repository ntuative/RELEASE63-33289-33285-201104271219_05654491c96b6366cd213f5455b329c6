package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_710:IssueMessageData = null;
      
      private var var_711:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2156 = param2.pickerUserName;
         this.var_1524 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1084 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1083;
         }
         if(this.var_710 == null || param1.timeStamp < this.var_710.timeStamp)
         {
            this.var_710 = param1;
         }
         if(this.var_711 == null || param1.priority > this.var_711.timeStamp)
         {
            this.var_711 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1084 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1083;
            }
            if(this.var_710 == _loc2_)
            {
               this.var_710 = null;
            }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_711;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_710;
         if(_loc2_ == null)
         {
