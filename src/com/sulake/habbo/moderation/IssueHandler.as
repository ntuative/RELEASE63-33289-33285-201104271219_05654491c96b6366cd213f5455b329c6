package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function createView() : void
      {
         ...
         this.var_548 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
         this.var_1259 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
         ...
         {
            this.var_1259.load(_loc4_,this.var_167.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_65 != null && this.var_65.issueManager != null && this.var_167 != null)
         {
            this.var_65.issueManager.removeHandler(this.var_167.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.closeBundle(this.var_167.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.closeBundle(this.var_167.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.closeBundle(this.var_167.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.issueManager.releaseBundle(this.var_167.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_65,WindowTracker.const_1175,_loc2_),this._window,false,false,true);
      }
