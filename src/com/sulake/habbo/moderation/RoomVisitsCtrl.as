package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1037:Array = [];
      
      private static var var_2023:int = 200;
      ...
      {
         this.var_843 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1037.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_843.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1037.length < var_2023)
         {
            ...
            param1.width = this.var_843.width;
            param1.height = this.var_843.height;
