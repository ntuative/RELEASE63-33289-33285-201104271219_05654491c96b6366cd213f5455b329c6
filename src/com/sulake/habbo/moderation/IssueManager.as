package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1079:String = "issue_bundle_open";
      
      public static const const_794:String = "issue_bundle_my";
      
      public static const const_1182:String = "issue_bundle_picked";
      
      public static const const_1747:int = 15000;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_616 = new IssueBrowser(this,this.var_65.windowManager,this.var_65.assets);
         this.var_1155 = [];
         this.var_1156 = [];
         this.var_951 = new Map();
         this.var_2435 = parseInt(this.var_65.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1784 = new Timer(const_1747,0);
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_182 && (_loc4_ == null || _loc5_.prioritySum > _loc4_.prioritySum))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_65.soundManager.playSound(HabboSoundTypesEnum.const_1130);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_950.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_950.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1554)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_106)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_950.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2434++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_950.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_182)
         {
            _loc6_ = this.getBundles(const_794);
            _loc7_ = false;
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2435);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_951.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_951.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_950.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_106.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in this.var_106)
         {
            ...
            {
               case const_1079:
                  if(_loc4_.state == IssueMessageData.const_182)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_951.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_951.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_951.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
