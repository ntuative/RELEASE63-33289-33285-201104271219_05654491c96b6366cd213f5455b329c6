package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1231:IDropMenuWindow;
      
      private var var_484:ITextFieldWindow;
      ...
      private var var_1507:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_34.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_368));
         Logger.log("BEGINNING TO SHOW: " + this.var_368);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_368);
         if(param1.flatId != this.var_368)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_368);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_484 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_484.procedure = this.onInputClick;
         this.var_1231 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1231);
         this.var_1231.procedure = this.onSelectTemplate;
         this.var_1000 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1508 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1507 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_693,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_659 || this.var_484.text == "")
         {
         ...
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1687,_loc2_,this.var_484.text,"",""));
         if(this.var_1508.isSelected || this.var_1507.isSelected || this.var_1000.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1508.isSelected,this.var_1507.isSelected,this.var_1000.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1699);
         }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1231.selection];
         if(_loc3_ != null)
         {
            this.var_659 = false;
            this.var_484.text = _loc3_;
         }
      }
   }
}
