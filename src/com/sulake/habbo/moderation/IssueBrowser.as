package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2109:String = "open_issues";
      
      private const const_2110:String = "picked_issues";
      
      private const const_2169:String = "closed_issues";
      ...
      private var var_1649:IIssueBrowserView;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2111:
               ...
               {
                  this.var_1649 = new MyIssuesView(this.issueManager,this,this.var_242.container);
               }
               return this.var_1649;
            case this.const_2109:
               if(this.var_1647 == null)
               {
                  this.var_1647 = new OpenIssuesView(this.issueManager,this,this.var_242.container);
               }
               return this.var_1647;
            case this.const_2110:
               if(this.var_1648 == null)
               {
                  this.var_1648 = new PickedIssuesView(this.issueManager,this,this.var_242.container);
               }
