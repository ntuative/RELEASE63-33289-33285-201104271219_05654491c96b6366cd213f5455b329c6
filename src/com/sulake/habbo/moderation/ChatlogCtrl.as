package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1737:int = 1000;
      
      private static var var_930:Array = [];
      
      private static var var_1738:int = 200;
      ...
      private var var_1736:IMessageComposer;
      ...
      {
         this.var_753 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_754 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         this.var_480 = new Timer(1000,1);
         ...
         this.var_34.connection.send(this.var_1736);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         ...
         return IWindowContainer(this.var_754.clone());
      }
      ...
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_931.length < var_1737)
         {
            ...
            param1.width = this.var_754.width;
            param1.height = this.var_754.height;
            var_931.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1739[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1409.getValue(param2.chatterName))
            {
               this.var_1409.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1409.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1407)
         {
