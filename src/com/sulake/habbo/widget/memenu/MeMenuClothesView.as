package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuClothesView implements IMeMenuView
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_792));
         }
         this._widget = null;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(this._widget.config.getKey("client.toolbar.static.enabled","false") == "IHabboSoundManager")
         {
