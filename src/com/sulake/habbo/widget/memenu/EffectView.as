package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2113:int = 1000;
      ...
      private var var_919:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_216 = new Timer(this.const_2113);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_181.isActive)
         {
            ...
            this.var_918.width = _loc2_ * this.var_318;
         }
         else
         {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_748 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_748 == null)
            {
               return;
            }
         ...
         if(!this.var_181.isActive)
         {
            this.var_748.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_748.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_748.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_919 = this._window.findChildByName("effect_hilite");
         ...
         if(this.var_918 != null)
         {
            this.var_318 = this.var_918.width;
            this.var_216.start();
            this.onUpdate();
         }
