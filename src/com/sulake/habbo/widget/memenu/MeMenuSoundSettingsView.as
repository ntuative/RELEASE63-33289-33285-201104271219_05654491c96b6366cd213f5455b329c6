package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      {
         this.var_563 = param1.volume;
         if(this.var_1023 != null)
         {
            this.var_1023.setValue(this.var_563);
         }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1984);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1983);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_563 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1985);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1982);
         }
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "sounds_on":
               ...
               break;
            case "back_btn":
               this._widget.changeView(MeMenuWidget.const_689);
               break;
            default:
