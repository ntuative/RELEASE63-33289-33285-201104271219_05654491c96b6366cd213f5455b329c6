package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidgetOld extends RoomWidgetBase
   {
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_867,this._visualization.window);
         if(messageListener != null)
         {
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         if(this._visualization != null)
         {
            ...
            this._visualization.showFloodBlocking(this.var_728);
         }
      }
