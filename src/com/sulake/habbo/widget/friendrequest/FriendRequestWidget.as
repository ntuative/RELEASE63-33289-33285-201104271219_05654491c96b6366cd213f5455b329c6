package com.sulake.habbo.widget.friendrequest
{
   ...
   public class FriendRequestWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.include,this.eventHandler);
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_544,this.eventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.include,this.eventHandler);
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_544,this.eventHandler);
      }
      ...
      private function eventHandler(param1:RoomWidgetFriendRequestUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFriendRequestUpdateEvent.include:
               ...
               break;
            case RoomWidgetFriendRequestUpdateEvent.const_544:
      ...
      public function update(param1:uint) : void
      {
         ...
         for each(_loc2_ in this._requests)
         {
            if(_loc2_)
            {
               _loc3_ = messageListener.processWidgetMessage(new RoomWidgetGetUserLocationMessage(_loc2_.userId,RoomObjectTypeEnum.const_180)) as RoomWidgetUserLocationUpdateEvent;
               if(_loc3_)
               {
