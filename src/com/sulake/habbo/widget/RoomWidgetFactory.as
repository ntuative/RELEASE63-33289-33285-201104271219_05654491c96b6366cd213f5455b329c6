package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2960:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2960 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_424:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_60,this.var_140,this.var_2878++,this,this._questEngine);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               if(this.var_140.getKey("new.chat.widget.enabled") == "1")
               {
                  _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_60,this.var_140,this);
               }
               else
               {
                  _loc2_ = new RoomChatInputWidgetOld(this._windowManager,assets,this.var_60,this.var_140,this);
               }
               break;
            case RoomWidgetEnum.const_567:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_60,this.var_140,this._catalog);
               break;
            case RoomWidgetEnum.const_549:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_60,events,this.var_140);
               break;
            ...
            case RoomWidgetEnum.const_633:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_60,this.var_140,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_540:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_60,this.var_140);
               break;
            case RoomWidgetEnum.const_774:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_60,this.var_140);
               break;
            case RoomWidgetEnum.const_129:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_60,this.var_140);
               break;
            ...
            case RoomWidgetEnum.const_123:
               _loc2_ = new AvatarInfoWidget(this._windowManager,assets,this.var_140,this.var_60,this);
               break;
            ...
            case RoomWidgetEnum.const_622:
               _loc2_ = new PlayListEditorWidget(this._windowManager,this._soundManager,assets,this.var_60,this.var_140,this._catalog);
               break;
