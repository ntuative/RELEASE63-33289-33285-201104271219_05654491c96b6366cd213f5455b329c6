package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListEditorItem
   {
      ...
      public static const const_524:String = "PLEI_ICON_STATE_NORMAL";
      
      public static const const_1189:String = "PLEI_ICON_STATE_PLAYING";
      ...
      private var var_2755:IContainerButtonWindow = null;
      ...
      private function createWindow() : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               this.var_2755 = _loc3_.getChildByName("button_remove_from_playlist") as IContainerButtonWindow;
            }
         }
      }
