   ...
   public class PlayListEditorItemListView
   {
      ...
      public function setItemIndexPlaying(param1:int) : void
      {
         ...
         if(param1 < 0)
         {
            ...
            {
               _loc3_.setIconState(PlayListEditorItem.const_524);
            }
            return;
         }
         ...
         if(this.var_1303 >= 0 && this.var_1303 < this._items.length)
         {
            _loc2_ = this._items[this.var_1303] as PlayListEditorItem;
            _loc2_.setIconState(PlayListEditorItem.const_524);
         }
         _loc2_ = this._items[param1] as PlayListEditorItem;
         _loc2_.setIconState(PlayListEditorItem.const_1189);
