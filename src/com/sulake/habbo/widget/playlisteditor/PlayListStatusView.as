package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_821:String = "PLSV_ADD_SONGS";
      
      public static const const_1141:String = "PLSV_START_PLAYBACK";
      
      public static const const_519:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_45 != const_519)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_432[this.var_45];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_432[const_821];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_432.add(const_519,_loc1_);
