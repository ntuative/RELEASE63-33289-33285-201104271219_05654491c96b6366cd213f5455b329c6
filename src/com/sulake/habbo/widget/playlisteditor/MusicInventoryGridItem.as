package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryGridItem
   {
      ...
      private var var_2754:IContainerButtonWindow = null;
      ...
      private function createWindow() : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_2754 = _loc2_.getChildByName("button_to_playlist") as IContainerButtonWindow;
         }
         ...
         this.playButtonState = const_588;
      }
