package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      public function refresh() : void
      {
         ...
         this._items = new Map();
         var _loc4_:int = this.var_67.getSongDiskInventorySize();
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc7_ = this.var_67.getSongDiskInventoryDiskId(_loc5_);
            _loc8_ = this.var_67.getSongDiskInventorySongId(_loc5_);
            _loc9_ = this.var_67.getSongInfo(_loc8_);
            _loc10_ = null;
            _loc11_ = null;
            if(_loc9_ != null)
            {
            ...
            this.var_617.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         if(this.var_98 != null)
         {
            this.var_98.playButtonState = MusicInventoryGridItem.const_1150;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_98 != null)
         {
            this.var_98.playButtonState = MusicInventoryGridItem.const_588;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_98.playButtonState == MusicInventoryGridItem.const_588)
               {
                  this.var_98.playButtonState = MusicInventoryGridItem.const_1240;
            ...
            {
               _loc4_ = this.var_617.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
