package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListEditorWidget extends RoomWidgetBase
   {
      ...
      private static const const_1397:int = 100;
      
      private static const const_1398:int = 130;
      
      private static const const_1395:int = 100;
      
      private static const const_1400:int = 130;
      ...
      {
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_805,this.onShowPlayListEditorEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_700,this.onHidePlayListEditorEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_941,this.onInventoryUpdatedEvent);
      }
      
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_805,this.onShowPlayListEditorEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_700,this.onHidePlayListEditorEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_941,this.onInventoryUpdatedEvent);
      }
      ...
      public function getDiskColorTransformFromSongData(param1:String) : ColorTransform
      {
         ...
         _loc2_ = uint(_loc2_ % const_1397 + const_1399);
         _loc3_ = uint(_loc3_ % const_1395 + const_1398);
         _loc4_ = uint(_loc4_ % const_1396 + const_1400);
      ...
      public function sendAddToPlayListMessage(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc4_ = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_815,_loc3_,param1);
      ...
      {
         var _loc2_:RoomWidgetPlayListModificationMessage = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_785,param1);
         if(messageListener != null)
         {
      ...
      public function sendTogglePlayPauseStateMessage() : void
      {
         ...
         var _loc2_:RoomWidgetPlayListPlayStateMessage = new RoomWidgetPlayListPlayStateMessage(RoomWidgetPlayListPlayStateMessage.const_875,this._furniId,_loc1_);
         if(messageListener != null)
         {
            messageListener.processWidgetMessage(_loc2_);
         }
      ...
      public function openSongDiskShopCataloguePage() : void
      {
         ...
         this._catalog.openCatalogPage(CatalogPageName.const_1537,true);
      }
