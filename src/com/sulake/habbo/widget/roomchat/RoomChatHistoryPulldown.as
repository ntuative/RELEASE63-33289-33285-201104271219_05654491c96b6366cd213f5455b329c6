package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_1051:int = 150;
      ...
      private var var_2702:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_1948 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2702 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1947 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1949 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2701 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2705 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_77 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_339,HabboWindowStyle.const_30,HabboWindowParam.const_61,new Rectangle(0,0,param3.width,param3.height - const_85),null,0,0) as IBitmapWrapperWindow;
         this.var_40.addChild(this.var_77);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_67,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_40.height - const_85,param3.width,const_85),null,0) as IWindowContainer;
         this.var_40.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_465,HabboWindowStyle.const_45,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_85),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_490:
               this.var_77.blend += param1 / const_1050;
               this._window.blend += param1 / const_1050;
               if(this._window.blend >= 1)
               {
                  this.state = const_377;
               }
               break;
            case const_979:
               this.var_77.blend -= param1 / const_1051;
               this._window.blend -= param1 / const_1051;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_40.height - const_85;
            this._window.width = this.var_40.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_40.height - const_85;
            this._region.width = this.var_40.width - this.var_2703;
         }
         if(this.var_77 != null)
         {
            this.var_77.rectangle = this.var_40.rectangle;
            this.var_77.height -= const_85;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2704 == this._window.width)
         {
            return;
         }
         this.var_2704 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2702;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1947;
            _loc2_.disposesBitmap = false;
            this.var_2703 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2706,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1948,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1948,_loc9_);
         ...
         this.var_77.bitmap = this.var_2705;
