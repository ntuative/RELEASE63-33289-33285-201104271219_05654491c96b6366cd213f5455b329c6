package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public static const const_1238:int = 3;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_178.state = RoomChatHistoryPulldown.const_273;
         ...
         this.var_49 = param2.createWindow("chatscroller","",HabboWindowType.const_1090,HabboWindowStyle.const_45,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_178.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_273);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_178.state == RoomChatHistoryPulldown.const_377 || this.var_178.state == RoomChatHistoryPulldown.const_490;
      }
      ...
      {
         if(!this.var_412 && !this.var_1952)
         {
            this.var_412 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_178.state = RoomChatHistoryPulldown.const_377;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_49 != null)
         {
            ...
            if(param2)
            {
               this.var_49.scrollV = this.var_584;
            }
         }
         if(this.var_178 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_411 > 0 && param2)
         {
            if(this.var_1644)
            {
               if(Math.abs(param1 - this.var_411) <= const_1238)
               {
                  return;
               }
               this.var_1644 = false;
            ...
            if(this.var_412)
            {
               ...
               _loc5_ = (param1 - this.var_411) / this.var_49.height;
               _loc3_ = this.var_584 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_411;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_49.scrollV < 1 - const_1325 / this.var_49.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1645)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_49 != null)
         {
            this.var_584 = this.var_49.scrollV;
         }
         if(this.var_49 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_584 - this.var_49.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
