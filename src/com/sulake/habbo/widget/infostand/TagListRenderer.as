package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_2136:int = 5;
      ...
      private var var_1152:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1151 = 0;
         this.var_1152 = param2.rectangle.clone();
         this.var_1152.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1152.width)
         {
            return false;
         }
         if(this.var_1151 + param1.height > this.var_1152.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1152.width)
         {
            this._offsetX = 0;
            this.var_1151 += param1.height + this.const_2137;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1151);
         this._offsetX += param1.width + this.const_2136;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1433 != null && this.var_1433.indexOf(param1) != -1)
         {
