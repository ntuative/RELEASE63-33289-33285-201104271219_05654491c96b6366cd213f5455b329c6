package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2132:int = 152;
      
      private const const_2121:int = 16;
      
      private const const_1359:int = 4;
      
      private const const_2123:uint = 14342874;
      
      private const const_2130:uint = 3815994;
      
      private const const_2125:uint = 2085362;
      
      private const const_2133:uint = 39616;
      
      private const const_2126:uint = 10513106;
      
      private const const_2122:uint = 8734654;
      
      private const const_2129:uint = 9094430;
      
      private const const_2128:uint = 6200576;
      
      private const const_2127:String = "happiness";
      
      private const const_2131:String = "experience";
      
      private const const_2124:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_46 == null || this.var_102 == null)
         {
            return;
         }
         this.var_102.width = this.var_102.width;
         this.var_102.visible = this.var_102.width > 0;
         this.var_53.height = this.var_53.scrollableRegion.height;
         this.var_46.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_46.width,this.var_102.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_46.width < this.var_102.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2127,param1.nutrition,param1.nutritionMax,this.const_2133,this.const_2125);
         this.updateStateElement(this.const_2131,param1.experience,param1.experienceMax,this.const_2122,this.const_2126);
         this.updateStateElement(this.const_2124,param1.energy,param1.energyMax,this.const_2128,this.const_2129);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2132,this.const_2121,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2123);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2130);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_547) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc4_:* = [];
         this.var_102.groupChildrenWithTag("CMD_BUTTON",_loc4_,true);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_202 && this.var_202.getPetId() == this.var_547)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1531,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_387,this._widget.petData.ownerId);
