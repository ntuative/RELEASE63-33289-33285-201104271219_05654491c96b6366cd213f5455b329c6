package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private const const_1060:int = 5;
      
      private const const_1875:int = 7829367;
      
      private const const_1874:int = 16777215;
      
      private const const_2166:int = 2000;
      
      private const const_2165:int = 50;
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1060;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1875;
            }
            else
            {
               _loc3_.textColor = this.const_1874;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_1060,this.const_2165);
         if(param2)
         {
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2803 > this.const_2166 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2803 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1875;
         }
      }
