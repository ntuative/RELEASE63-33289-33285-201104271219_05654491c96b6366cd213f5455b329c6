package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_2662 = param1.petRace;
         this.var_47 = param1.image;
         this.var_2312 = param1.isOwnPet;
         this.var_2292 = param1.ownerId;
         this._ownerName = param1.ownerName;
         this._canOwnerBeKicked = param1.canOwnerBeKicked;
         this.var_1427 = param1.level;
         this.var_2317 = param1.levelMax;
         this.var_2289 = param1.experience;
         this.var_2316 = param1.experienceMax;
         this._energy = param1.energy;
         this.var_2311 = param1.energyMax;
         this._nutrition = param1.nutrition;
         this.var_2313 = param1.nutritionMax;
         this._petRespect = param1.petRespect;
         this.var_2315 = param1.roomIndex;
         this.var_556 = param1.age;
      }
   }
}
