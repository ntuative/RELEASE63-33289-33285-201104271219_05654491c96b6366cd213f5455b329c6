package com.sulake.habbo.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      private const const_1842:int = 3;
      
      private const const_2116:uint = 4.291993382E9;
      
      private const const_2114:uint = 4.29080704E9;
      
      private const const_2117:uint = 4.285767869E9;
      
      private const const_2115:uint = 4.28366404E9;
      ...
      public function PurseWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager)
      {
         ...
         if(_loc4_)
         {
            ...
            this._view.x = _loc5_.width - this._view.width - this.const_1842;
            this._view.y = this.const_1842;
      ...
      {
         this.var_1712 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("credits").caption = this.var_1712.toString();
            this._view.findChildByName("credits_shadow").caption = this.var_1712.toString();
         }
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_1713 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_1713.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_1713.toString();
         }
      }
      
      private function onCreditsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1290));
      }
      
      private function onPixelsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1101));
      }
