package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_975:uint = 0;
      
      protected static const const_640:uint = 1;
      ...
      protected function updateButtons() : void
      {
         ...
         if(this.var_571 == const_975 || this.var_571 == const_640)
         {
            ...
            else
            {
               ...
               this.var_571 = const_640;
            }
         }
         if(this.var_571 == const_640)
         {
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            else
            {
               ...
               {
                  case "link_moderate":
                     this.var_571 = const_1311;
                     this.updateButtons();
                     break;
                  case "link_show_actions":
                     this.var_571 = const_975;
                     this.updateButtons();
                     break;
