package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarInfoView
   {
      ...
      private static const const_1375:int = 25;
      ...
      protected var var_2122:FixedSizeStack;
      
      protected var var_2123:int = -1000000;
      ...
      {
         this.var_2122 = new FixedSizeStack(const_1375);
         super();
         this._widget = param1;
         this._userId = param2;
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_954));
      ...
      public function update(param1:Rectangle, param2:Point, param3:Number) : void
      {
         ...
         if(!this.var_1329)
         {
            ...
            if(this.var_1609 == RoomObjectTypeEnum.const_180 || this.var_1609 == RoomObjectTypeEnum.const_631)
            {
            ...
            this.var_2122.addValue(_loc5_);
            _loc6_ = this.var_2122.getMax();
            if(_loc6_ < this.var_2123 - const_1002)
            {
               _loc6_ = this.var_2123 - const_1002;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2123 = _loc6_;
