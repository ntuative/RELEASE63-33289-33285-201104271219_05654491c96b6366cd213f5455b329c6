package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_1010:String = "Girl";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_1284,this.onUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_1284,this.onUpdate);
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         this.var_2254 = param1.objectCategory;
         ...
         this._window = windowManager.createWindow("clothing change gender selection","",HabboWindowType.const_67,HabboWindowStyle.const_45,0 | 0 | 0 | 0,new Rectangle(100,100,200,200),null,0) as IWindowContainer;
         ...
         _loc4_ = this._window.findChildByName(const_1010);
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onGenderSelectionMouseEvent);
         }
      ...
      private function hideEditorInterface() : void
      {
         ...
         {
            _loc1_ = this.var_775 as IFrameWindow;
            if(_loc1_ != null)
            {
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         _loc5_.setParamFlag(HabboWindowParam.const_168,true);
         this.var_775 = _loc4_;
         this.var_775.offset(100,100);
         var _loc6_:IWindow = this.var_775.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = this.onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_438,param1,this.var_218,this.var_2254,this._roomId,this._roomCategory,_loc5_);
