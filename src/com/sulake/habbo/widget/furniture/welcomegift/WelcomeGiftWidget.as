package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_1515:String = "welcome_gift_email_change";
      
      private const const_2168:int = 4;
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_680:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1053;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_1053);
               break;
            ...
            case this.const_1515:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1053);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1586;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1515);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_893,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1306 ? this.const_1069 : this.const_680);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1587 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1587));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_596,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_694,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_596,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_694,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_596:
               this.var_1586 = param1.email;
               this.var_1306 = param1.isVerified;
               this.var_1053 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1586 = this.var_1587;
            this.setViewState(this.const_680);
         }
         else
         {
            if(param1.result == this.const_2168)
            {
               this.var_1053 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1587);
