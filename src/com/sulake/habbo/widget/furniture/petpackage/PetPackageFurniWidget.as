package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      {
         var _loc2_:* = null;
         if(this.var_693 == null || this._window == null)
         {
            return;
         }
         ...
         if(_loc1_ != null)
         {
            ...
            _loc2_ = new Point((_loc1_.width - this.var_693.width) / 2,(_loc1_.height - this.var_693.height) / 2);
            _loc1_.bitmap.copyPixels(this.var_693,this.var_693.rect,_loc2_);
         }
      }
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1312 || this.var_218 == -1)
         {
            return;
         }
         ...
         {
            this.var_1312 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_931,this.var_218,name);
