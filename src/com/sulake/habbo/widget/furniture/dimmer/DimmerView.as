package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_615:DimmerViewColorGrid;
      
      private var var_429:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_67,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1356,WINDOW_INITIAL_Y,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_615 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_429 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(this.var_429 != null)
         {
            this.var_429.setValue(this.var_1439);
         }
         this.var_562 = this.colors.indexOf(_loc2_.color);
         if(this.var_615 != null)
         {
            this.var_615.setSelectedColorIndex(this.var_562);
         }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_429 != null)
         {
            this.var_429.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_615 != null)
         {
            this.var_615.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
