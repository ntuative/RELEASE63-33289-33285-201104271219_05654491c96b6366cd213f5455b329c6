package com.sulake.habbo.widget.furniture.ecotronbox
{
   ...
   public class EcotronBoxFurniWidget extends RoomWidgetBase
   {
      ...
      private function showInterface() : void
      {
         ...
         this._window = windowManager.createWindow("ecotronboxcardui_container","",HabboWindowType.const_67,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1356,WINDOW_INITIAL_Y,2,2),null,0) as IWindowContainer;
      ...
      {
         var _loc1_:* = null;
         if(this.var_334 || this.var_218 == -1 || !this._controller)
         {
            return;
         }
         this.var_334 = true;
         ...
         {
            _loc1_ = new RoomWidgetEcotronBoxOpenMessage(RoomWidgetEcotronBoxOpenMessage.const_836,this.var_218);
