package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_169.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_146,HabboWindowStyle.const_45,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1863,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_169.habboConfiguration.getKey("use.sso","false") == "IHabboSoundManager")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1863,"/");
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_143.removeEventListener(SSOTicket.const_375,this.onParsedTicketSuccess);
            this.var_143.removeEventListener(SSOTicket.const_310,this.onParsedTicketFailure);
            this.var_143 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_143 = new SSOTicket(this.var_169.assets,_loc3_,_loc2_,param1);
         this.var_143.addEventListener(SSOTicket.const_375,this.onParsedTicketSuccess);
         this.var_143.addEventListener(SSOTicket.const_310,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_169.flashClientUrl = this.var_143.flashClientUrl;
         this.var_169.ssoTicket = this.var_143.ticket;
         this.var_143.removeEventListener(SSOTicket.const_375,this.onParsedTicketSuccess);
         this.var_143.removeEventListener(SSOTicket.const_310,this.onParsedTicketFailure);
         this.var_143 = null;
         dispatchEvent(new Event(const_495));
