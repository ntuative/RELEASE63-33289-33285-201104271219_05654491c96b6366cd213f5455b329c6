package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1423:IDesktopWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_1139:Function;
      
      private var var_1140:Function;
      
      private var var_764:IAssetLibrary;
      
      private var var_1138:uint = 0;
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher, param4:Boolean = true)
      {
         ...
         this.var_764 = param2;
         this._events = param3;
         this.var_1423 = param1.getDesktop(0);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_764.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_764.getAssetByName(_loc2_.assetName);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_764.loadAssetFromFile("hotel_view_banner_" + this.var_1138,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1423.addChildAt(this._window,0);
         }
      }
      ...
      public function hide() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1423.removeChild(this._window);
         }
      }
   }
}
