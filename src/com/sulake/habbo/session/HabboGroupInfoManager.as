package com.sulake.habbo.session
{
   ...
   public class HabboGroupInfoManager
   {
      ...
      private function onGroupDetails(param1:IMessageEvent) : void
      {
         ...
         _loc3_.badgeId = this.var_262.getValue(_loc2_.groupId);
         this.var_1502[_loc2_.groupId] = _loc3_;
      ...
      {
         var _loc2_:HabboGroupDetails = this.var_1502[param1];
         if(_loc2_ == null)
         {
