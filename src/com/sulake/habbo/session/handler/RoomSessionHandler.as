package com.sulake.habbo.session.handler
{
   ...
   public class RoomSessionHandler extends BaseHandler
   {
      ...
      public static const const_1145:String = "RS_CONNECTED";
      
      public static const const_1224:String = "RS_READY";
      ...
      private function onRoomConnected(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_1145);
         }
      }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            ...
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_1224);
         }
      }
