package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1387:String = "sendAccessTokenToServer";
      
      private static const const_1388:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1387,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1388,this.jsFaceBookLogOutCallback);
