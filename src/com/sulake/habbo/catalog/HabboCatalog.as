package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_1109:IRoomSession;
      ...
      private var var_2391:Boolean = true;
      
      private var var_1765:Boolean = false;
      
      private var var_2392:GiftWrappingConfiguration;
      
      private var var_1144:ClubGiftController;
      
      private var var_508:ClubBuyController;
      
      private var var_766:Map;
      
      private var var_1145:Boolean = false;
      
      private var var_768:IPurchasableOffer;
      
      private var var_1426:IDragAndDropDoneReceiver;
      
      private var var_69:PlacedObjectPurchaseData;
      
      private const const_1062:Point = new Point(100,20);
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            ...
            this.var_225.showOffer(this,param1,param2,param3,_loc5_);
            if(param4)
            {
         ...
         {
            this.var_508.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_184.getKey("client.credits.embed.enabled","false") == "IHabboSoundManager";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_428.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_428.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_65)
         {
            _loc3_ = this.var_428.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_105.getActivityPointsForType(Purse.const_205)));
         var _loc1_:int = 0;
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_716)
         {
            if(!this.var_428.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_58,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this.mainWindowVisible())
         {
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer.position = this.const_1062;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_263,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_87:
               this.var_1765 = param1.session.isPrivateRoom;
               this.var_1109 = param1.session;
               if(this.var_90 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1144 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_508 == null)
         {
            this.var_508 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_349.openPage(this.var_767);
            this.var_767 = "";
            this.var_940 = -1;
         }
         else if(this.var_940 > -1)
         {
            this.var_349.openPageById(this.var_940,this.var_1766);
            this.var_940 = -1;
            this.var_1766 = -1;
            this.var_767 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2393 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1307);
         }
         this.var_2393 = false;
         if(this.var_299 != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_74,this.var_105.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2391 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1171);
         }
         this.var_2391 = false;
         if(this.var_299 != null)
         {
         ...
         if(_loc2_.type == Purse.const_205)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1144.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2392 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "IHabboSoundManager" == this.var_184.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
      ...
      {
         if(!this.var_184.keyExists("catalog.drag_and_drop") || this.var_184.getKey("catalog.drag_and_drop") != "IHabboSoundManager")
         {
            return false;
         }
         if(!this.var_1109 || !this.var_1109.isRoomOwner)
         {
            return false;
         }
      ...
      private function updateRoom(param1:String, param2:String) : void
      {
         ...
         var _loc4_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_202);
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_206);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1145 && param1.type == RoomEngineObjectEvent.const_172)
         {
            this.resetPlacedOfferData();
            ...
            _loc3_ = this.var_768.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_69 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_768);
            _loc5_ = this.var_1426;
            this.resetObjectMover();
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_353,0.5);
            }
         }
      }
      ...
      public function resetPlacedOfferData() : void
      {
         ...
         if(this.var_69 != null)
         {
            if(this.var_69.category == RoomObjectCategoryEnum.const_27)
            {
               this._roomEngine.disposeObjectFurniture(this.var_69.roomId,this.var_69.roomCategory,this.var_69.objectId);
            }
            else if(this.var_69.category == RoomObjectCategoryEnum.const_26)
            {
               _loc1_ = this.var_768.productContainer.firstProduct;
               switch(_loc1_.furnitureData.name)
               {
                  ...
                  case "landscape":
                     ...
                     break;
                  default:
                     this._roomEngine.disposeObjectWallItem(this.var_69.roomId,this.var_69.roomCategory,this.var_69.objectId);
               }
            }
            else
            {
               this._roomEngine.deleteRoomObject(this.var_69.objectId,this.var_69.category);
            }
            this.var_69.dispose();
            this.var_69 = null;
         }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_202);
         ...
         if(this.var_69 && this.var_69.productClassId == param1.classId)
         {
            if(this.var_69.roomCategory == this._roomEngine.activeRoomCategory && this.var_69.roomId == this._roomEngine.activeRoomId)
            {
               _loc5_ = param1.stripId;
               _loc6_ = this.var_69.category;
               _loc7_ = this.var_69.wallLocation;
               _loc8_ = this.var_69.x;
               _loc9_ = this.var_69.y;
               _loc10_ = this.var_69.direction;
