package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1853:uint = 4.293848814E9;
      
      private const const_1854:uint = 4.294967295E9;
      
      private const const_1494:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_761 = _loc1_.boxTypes;
            this.var_762 = _loc1_.ribbonTypes;
            this.var_1137 = this.var_1686[0];
            this.var_346 = this.var_761[0];
            this.var_345 = this.var_762[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_345 < 0)
         {
            this.var_345 = this.var_762.length - 1;
         }
         if(this.var_345 > this.var_762.length - 1)
         {
            this.var_345 = 0;
         }
         if(this.var_346 < 0)
         {
            this.var_346 = this.var_761.length - 1;
         }
         if(this.var_346 > this.var_761.length - 1)
         {
            this.var_346 = 0;
         }
         var _loc1_:int = this.var_761[this.var_346] * 1000 + this.var_762[this.var_345];
         if(this._window == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_761[this.var_346]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_762[this.var_345]);
         this._catalog.purchaseProductAsGift(this.var_1420,this.var_93,this.var_1422,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1420,this.var_93.offerId,this.var_1422);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_251 == null || this.var_610 == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1494;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1853) : uint(this.const_1854);
      }
