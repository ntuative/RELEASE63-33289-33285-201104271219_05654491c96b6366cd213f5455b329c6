package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_2041:IProductData;
      
      private var var_609:IFurnitureData;
      ...
      private function setOfferData(param1:IPurchasableOffer) : void
      {
         ...
         this.var_2042 = param1.productContainer.firstProduct.productClassId;
         this.var_2041 = param1.productContainer.firstProduct.productData;
         this.var_609 = param1.productContainer.firstProduct.furnitureData;
         this.var_1422 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_218,this._category,this.var_2043,this._x,this.var_161,this._direction,this._offerId,this.var_2042].toString();
      }
