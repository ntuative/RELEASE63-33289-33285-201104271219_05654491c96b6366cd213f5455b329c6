package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_653 != const_1040;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1915 != RecyclerStatusMessageEvent.const_1174;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_653 == const_458;
      }
      ...
      {
         this.var_653 = const_1039;
         this.var_124 = new Array(const_200);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1915)
         {
            case RecyclerStatusMessageEvent.const_1578:
               this.var_653 = const_458;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1174:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1253:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1591:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_124.length < const_200)
         {
            return false;
         }
         var _loc1_:int = 0;
