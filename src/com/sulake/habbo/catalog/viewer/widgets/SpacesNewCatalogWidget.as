package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer)
      {
         ...
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_438.numSelectables)
            {
               _loc3_ = this.var_438.getSelectableAt(_loc2_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_101[this.var_514]);
      ...
      {
         var _loc2_:int = this.var_782[this.var_514];
         var _loc3_:Offer = this.var_207[this.var_514][_loc2_];
      ...
      public function selectIndex(param1:int) : void
      {
         ...
         {
            _loc2_ = this.var_207[this.var_514][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_782[this.var_514] = (this.var_207[this.var_514] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_782[0];
         var _loc2_:int = this.var_782[1];
         var _loc3_:int = this.var_782[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_430 || _loc1_.pricingModel == Offer.const_404))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_65 || _loc2_.productType == ProductTypeEnum.const_79))
            {
               continue;
            }
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_207[this.var_514],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_782[this.var_514];
