package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class LocalizationCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function onClickLink(param1:WindowMouseEvent) : void
      {
         ...
         switch(page.layoutCode)
         {
               ...
               switch(_loc4_)
               {
                  ...
                  case "ctlg_txt7":
                     if(IWindow(param1.target).caption != "")
                     {
                        ...
                        {
                           if(false && "IHabboSoundManager" == _loc3_.getKey("client.credits.embed.enabled"))
                           {
            ...
            case "info_pixels":
               ...
               {
                  case "ctlg_text_5":
                     page.viewer.catalog.openInventoryCategory(InventoryCategory.const_382);
                     break;
                  case "ctlg_text_7":
      ...
      private function retrieveCatalogImage(param1:String) : void
      {
         ...
         var _loc5_:String = this.var_1034[param1];
