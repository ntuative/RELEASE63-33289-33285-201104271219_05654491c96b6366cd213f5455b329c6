package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IRecyclerVisualization
   {
      ...
      private var var_312:CatalogObjectMover;
      ...
      private function renderSlotGraphics() : void
      {
         ...
         _loc2_ = 1;
         while(_loc2_ <= RecyclerLogic.const_200)
         {
      ...
      public function updateSlots() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < RecyclerLogic.const_200)
         {
      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_25:
               if(this.var_312 != null)
               {
                  this.var_312.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(this.var_312 == null)
               {
                  this.var_312 = new CatalogObjectMover();
                  this.var_312.mainContainer = window;
                  this.var_312.roomEngine = _loc3_;
               }
               this.var_312.onMainContainerEvent(param1,param2,_loc4_);
         }
      }
