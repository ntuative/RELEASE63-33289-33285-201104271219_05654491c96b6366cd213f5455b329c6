package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1922:Point;
      
      private var var_534:IItemGridWindow;
      
      private var var_1509:IScrollbarWindow;
      
      protected var var_1820:XML;
      
      private var var_2677:Array;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1002 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1232 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1922 = new Point(this.var_86.x,this.var_86.y);
         this.var_534 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1509 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1921 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1002.text = _loc4_;
         this.var_1232.text = _loc5_;
         this.var_1002.height = this.var_1002.textHeight + 5;
         this.var_1232.y = this.var_1002.y + this.var_1002.height;
         this.var_1232.height = Math.max(130,this.var_1232.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_560:
                  _loc6_ = this.var_1921.clone();
                  if(this.var_534 != null)
                  {
                     this.var_534.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_534,this.var_1509,this.var_1820);
                     ...
                     case ProductTypeEnum.const_203:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_311,AvatarAction.const_574);
                              _loc16_.appendAction(AvatarAction.const_344,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2677)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2677 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_86 != null && true)
         {
            ...
            this.var_86.x = this.var_1922.x;
            this.var_86.y = this.var_1922.y;
            if(param3 != null)
            {
