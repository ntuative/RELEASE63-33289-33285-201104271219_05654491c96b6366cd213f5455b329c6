package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_347:IItemGridWindow;
      ...
      {
         if(!this.var_347.disposed)
         {
            this.var_347.destroyGridItems();
      ...
      override public function init() : Boolean
      {
         ...
         this.var_347 = _window.findChildByName("colourGrid") as IItemGridWindow;
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         this.var_934 = _loc4_.content as BitmapData;
         _loc5_ = page.viewer.catalog.assets.getAssetByName(param1.chosenColourAssetName) as BitmapDataAsset;
         this.var_936 = _loc5_.content as BitmapData;
         this.populateColourGrid();
         this.select(this.var_347.getGridItemAt(0) as IWindowContainer);
      }
      ...
      private function onAvailableMultiColours(param1:CatalogWidgetMultiColoursEvent) : void
      {
         ...
         for each(_loc2_ in param1.colours)
         {
            this.var_935.push(_loc2_.slice());
         }
         _loc3_ = page.viewer.catalog.assets.getAssetByName(param1.backgroundAssetName) as BitmapDataAsset;
         this.var_611 = _loc3_.content as BitmapData;
         _loc4_ = page.viewer.catalog.assets.getAssetByName(param1.colourAssetName) as BitmapDataAsset;
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_935.length,this.var_347.numGridItems]);
         this.var_347.destroyGridItems();
         this.var_362 = null;
         for each(_loc1_ in this.var_935)
         {
            if(_loc1_.length > 0)
            {
               ...
               this.var_347.addGridItem(_loc2_);
               ...
               if(_loc4_ != null)
               {
                  _loc4_.bitmap = new BitmapData(this.var_934.width,this.var_934.height,true,0);
                  _loc6_ = 255;
                  _loc7_ = 255;
                  _loc8_ = 255;
                  _loc9_ = null;
               ...
               if(_loc5_ != null)
               {
                  _loc5_.bitmap = new BitmapData(this.var_936.width,this.var_936.height,true,16777215);
                  _loc5_.bitmap.copyPixels(this.var_936,this.var_936.rect,new Point(0,0),null,null,true);
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_347.getGridItemIndex(param1.target as IWindow);
