package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2119:int = 40;
      
      private const const_2118:int = 10;
      
      private var var_751:Array;
      
      private var var_1391:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_502)
         {
            this.var_502.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_502 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_751 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_751 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_751));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_600)
         {
            ...
            this.var_600 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_600)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1843,_loc2_.length);
         if(!this.var_502)
         {
            this.var_502 = new Timer(25);
            this.var_502.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1126 = 0;
         this.populateList();
         this.var_502.start();
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_600 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_600.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1844);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_751.length)
         {
            _loc4_ = this.var_751[_loc6_.selection];
         }
         ...
         else if(param1.type == WindowEvent.const_105)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2118;
                  break;
               case "search_input":
                  _loc8_ = this.const_2119;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1391.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_57)
