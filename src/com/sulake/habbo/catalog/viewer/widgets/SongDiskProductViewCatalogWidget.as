package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      public function SongDiskProductViewCatalogWidget(param1:IWindowContainer, param2:IHabboSoundManager)
      {
         ...
         this.var_1290 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         ...
         this.var_1291 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this._soundManager.musicController.playSong(this.var_1043,HabboMusicPrioritiesEnum.const_204,15,40,0.5,2);
         }
      }
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1290.text = _loc8_;
            }
         }
         else if(this.var_1290 != null)
         {
            this.var_1290.text = "";
         }
         if(this.var_427 != null)
