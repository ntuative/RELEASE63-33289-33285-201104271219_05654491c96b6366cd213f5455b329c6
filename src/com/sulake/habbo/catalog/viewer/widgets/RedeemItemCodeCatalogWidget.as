package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1042.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1042 = null;
         }
         if(this.var_1041 != null)
         {
            this.var_1041.removeEventListener(WindowKeyboardEvent.const_181,this.windowKeyEventProcessor);
            this.var_1041 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1042 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1042 != null)
         {
            this.var_1042.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1041 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1041 != null)
         {
            this.var_1041.addEventListener(WindowKeyboardEvent.const_181,this.windowKeyEventProcessor);
         }
         return true;
      }
