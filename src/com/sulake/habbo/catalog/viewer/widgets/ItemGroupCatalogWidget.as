package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_207[this.var_514][this.var_782];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_514 = var_572.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_514];
         var _loc3_:Array = this.var_207[this.var_514] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_782 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_782] as Offer;
         ...
         for each(_loc1_ in page.offers)
         {
            if(_loc1_.pricingModel == Offer.const_430 || _loc1_.pricingModel == Offer.const_404)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_65 || _loc3_.productType == ProductTypeEnum.const_79)
                  {
