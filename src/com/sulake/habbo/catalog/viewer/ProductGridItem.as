package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_991:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_252:IItemGrid;
      ...
      {
         this._view.getChildByName(const_991).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_991).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         if(this._view)
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_91,MouseCursorType.const_1289);
         }
      }
