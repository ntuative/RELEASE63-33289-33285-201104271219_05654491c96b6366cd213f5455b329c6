package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1828:String = "ctlg_";
      ...
      private var var_506:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1133:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_506 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1134);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1134);
      }
      ...
      {
         var _loc2_:String = const_1828 + param1;
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1566:
               if(this.var_1133 == null)
               {
                  this.var_1133 = new ItemGridCatalogWidget(param1);
                  this.var_37.push(this.var_1133);
               }
               break;
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_506.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_506 != null)
         {
            return this.var_506.dispatchEvent(param1);
         }
         return false;
      }
