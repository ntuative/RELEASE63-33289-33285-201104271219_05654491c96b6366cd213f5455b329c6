package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2971:String = "magic.credits";
      
      private var var_2927:String = "magic.pixels";
      
      private var var_2926:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2927);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2926,true);
      }
