package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample
   {
      ...
      public static const const_1712:String = "sample_44khz";
      
      public static const const_1560:String = "sample_22khz";
      
      public static const const_1729:String = "sample_11khz";
      
      public static const const_1633:String = "sample_16bit";
      
      public static const const_1522:String = "sample_8bit";
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_162 * this.var_74;
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1008)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1008);
            }
            ...
            {
               this.var_131[int(_loc11_ / this.var_162)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_131.length * this.var_162 * this.var_74;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_162 * this.var_74;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
      ...
      public function method_5(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc9_:* = 0;
