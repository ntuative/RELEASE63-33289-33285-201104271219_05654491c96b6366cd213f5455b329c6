package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1519:int = 60;
      ...
      private var var_563:Number = 1.0;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_793,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1130:
                  _loc3_ = "sound_call_for_help";
                  break;
               case HabboSoundTypesEnum.const_1585:
               ...
               case HabboSoundTypesEnum.const_1171:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1307:
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1310.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_691,events);
         _loc5_.volume = this.var_563;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_691.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      {
         if(this.var_184 == null || this._connection == null || this._roomEngine == null || this.var_67 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1556,this.var_854));
         this.var_854 = -1;
         this.var_853 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_563 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_563 * 100)));
         }
      }
      ...
      {
         this.var_563 = param1;
         this.var_67.updateVolume(this.var_563);
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         if(this.var_690.getValue(param1) != null)
         {
            ...
            if(this.var_691.getValue(_loc2_) == null)
            {
               this.var_1588.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1588,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1588,_loc2_,TraxSample.const_1712,TraxSample.const_1633);
               this.var_691.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1311.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1519 && this.var_1311.length > 0)
            {
               _loc3_ = this.var_1311.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_690.length == 0 && this.var_854 != -1)
            {
               this.var_853.ready = true;
               _loc4_ = this.var_854;
               this.var_854 = -1;
               this.var_853 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_793,_loc4_));
            }
         }
      }
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_853 == null && this.var_1310.length > 0)
         {
            _loc1_ = this.var_1310.getKey(0);
            _loc2_ = this.var_1310.remove(_loc1_);
            if(_loc2_ != null)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_793,_loc1_));
               }
               else
               {
                  this.var_853 = _loc2_;
