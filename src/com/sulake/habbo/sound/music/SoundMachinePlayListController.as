package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_818,this.onSoundMachinePlayEvent);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_870,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_80)
            {
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_818,this.onSoundMachinePlayEvent);
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_870,this.onSoundMachineStopEvent);
               this.var_80 = null;
            }
            this._disposed = true;
         }
      ...
      public function stopPlaying() : void
      {
         this.var_447 = -1;
         this.var_679 = false;
         this.var_67.stop(HabboMusicPrioritiesEnum.const_132);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_67.playSong(param1,HabboMusicPrioritiesEnum.const_132,_loc3_,0,0,0))
         {
