package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1503:int = HabboMusicPrioritiesEnum.const_132;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_902,this.onJukeboxInit);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_255,this.onJukeboxDispose);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_809,this.onSoundMachineInit);
         this.var_80.addEventListener(RoomEngineSoundMachineEvent.const_811,this.onSoundMachineDispose);
         ...
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_264)
         {
            this.var_557[_loc6_] = null;
            this.var_847[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_80)
            {
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_902,this.onJukeboxInit);
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_255,this.onJukeboxDispose);
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_809,this.onSoundMachineInit);
               this.var_80.removeEventListener(RoomEngineSoundMachineEvent.const_811,this.onSoundMachineDispose);
            }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_264)
         {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_845));
         Logger.log("Requested song info\'s : " + this.var_845);
         this.var_845 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               while(this.var_846.indexOf(_loc6_.id) != -1)
               {
                  this.var_846.splice(this.var_846.indexOf(_loc6_.id),1);
                  if(this.var_846.length == 0)
                  {
                     this._events.dispatchEvent(new SongDiskInventoryReceivedEvent(SongDiskInventoryReceivedEvent.const_616));
                  }
               }
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_264)
         {
            return false;
         }
         ...
         if(this._priorityPlaying <= const_1503)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_132)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_587,param1,_loc4_.id,-1));
         }
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2817 != param1.id || _loc3_ > this.var_2816 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2817 = param1.id;
            this.var_2816 = _loc3_;
         }
      }
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_558 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_80,this._connection) as IPlayListController;
      }
