package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_67.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_132,_loc3_.syncCount / 1000,0,1,1);
         ...
         this.var_1979 = _loc3_.currentPosition;
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_347,HabboMusicPrioritiesEnum.const_132,_loc3_.currentSongId,_loc3_.currentPosition));
      }
      ...
      private function onJukeboxSongDisksMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDisks.length)
         {
            ...
            if(_loc7_ == null)
            {
               ...
               if(this.var_826.indexOf(_loc5_) < 0)
               {
      ...
      private function onJukeboxPlayListFullMessage(param1:IMessageEvent) : void
      {
         ...
         this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_782));
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         var _loc3_:int = this.var_826.indexOf(param1.id);
         if(_loc3_ >= 0)
         {
            this.var_826.splice(_loc3_,1);
         }
         if(this.var_826.length == 0)
         {
            this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.PLAY_LIST_UPDATED));
